...
---
Generated by: DevOps Subagent (@Dario)
...
3. **DevOps (@Dario) creates PR** → Runs CI/CD
...
```
@Dario - Quarterly Cost Review Due
...
```
@Dario - Production deployment failed
