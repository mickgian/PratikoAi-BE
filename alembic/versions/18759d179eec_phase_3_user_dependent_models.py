...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("idx_kc_vec"), table_name="knowledge_chunks", postgresql_with={"lists": "100"}, postgresql_using="ivfflat"
    )
    ...
    op.drop_index(
        op.f("idx_ki_text_quality"), table_name="knowledge_items", postgresql_where="(text_quality IS NOT NULL)"
    )
    op.drop_index(
        op.f("idx_ki_vec"), table_name="knowledge_items", postgresql_with={"lists": "50"}, postgresql_using="ivfflat"
    )
