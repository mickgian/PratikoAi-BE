...
down_revision: str | Sequence[str] | None = "6c9df3d39110"
...
def upgrade() -> None:
    ...
    safe_create_index(op.f("ix_user_refresh_token_hash"), "user", ["refresh_token_hash"], unique=False)
...
def downgrade() -> None:
    ...
    safe_create_index(op.f("idx_ki_fts"), "knowledge_items", ["search_vector"], unique=False, postgresql_using="gin")
    safe_create_index(
    ...
    safe_create_index(op.f("idx_kc_fts"), "knowledge_chunks", ["search_vector"], unique=False, postgresql_using="gin")
    safe_create_index(
    ...
    safe_create_index(op.f("idx_feed_status_url_unique"), "feed_status", ["feed_url"], unique=True)
    safe_create_index(op.f("idx_feed_status_status"), "feed_status", ["status"], unique=False)
    safe_create_index(op.f("idx_feed_status_source"), "feed_status", ["source"], unique=False)
    safe_create_index(op.f("idx_feed_status_parser"), "feed_status", ["parser"], unique=False)
    safe_create_index(op.f("idx_feed_status_last_checked"), "feed_status", ["last_checked"], unique=False)
    safe_create_index(op.f("idx_feed_status_errors"), "feed_status", ["consecutive_errors"], unique=False)
    safe_create_index(op.f("idx_feed_status_enabled"), "feed_status", ["enabled"], unique=False)
    op.alter_column(
        "feed_status",
        "updated_at",
        existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    safe_create_index(op.f("idx_document_processing_log_status"), "document_processing_log", ["status"], unique=False)
    safe_create_index(
    ...
    safe_create_index(op.f("idx_document_collections_status"), "document_collections", ["status"], unique=False)
    safe_create_index(op.f("idx_document_collections_source"), "document_collections", ["source"], unique=False)
    safe_create_index(
