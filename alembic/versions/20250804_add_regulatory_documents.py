...
Revision ID: add_regulatory_docs_20250804
...
revision = "add_regulatory_docs_20250804"
...
def upgrade():
    ...
    if not table_exists("regulatory_documents"):
        op.create_table(
            ...
            sa.Column(
                "published_date", sa.DateTime(timezone=True), nullable=True, comment="Official publication date"
            ),
            sa.Column("content", sa.Text(), nullable=False, comment="Extracted text content"),
            sa.Column(
                "content_hash", sa.String(length=64), nullable=False, comment="SHA256 hash for duplicate detection"
            ),
            ...
            sa.Column(
                "processing_errors", sa.Text(), nullable=True, comment="Any errors encountered during processing"
            ),
            sa.Column(
                "knowledge_item_id", sa.Integer(), nullable=True, comment="Associated knowledge_items record ID"
            ),
    ...
    if not table_exists("feed_status"):
        op.create_table(
            ...
            sa.Column(
                "enabled", sa.Boolean(), nullable=False, default=True, comment="Whether feed monitoring is enabled"
            ),
            sa.Column(
                "created_at",
                sa.DateTime(timezone=True),
    ...
    if not table_exists("document_processing_log"):
        op.create_table(
            ...
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column(
                "document_id", sa.String(length=100), nullable=True, comment="Associated regulatory document ID"
            ),
    ...
    if not table_exists("document_collections"):
        op.create_table(
            ...
            sa.Column(
                "document_type", sa.String(length=100), nullable=False, comment="Type of documents in collection"
            ),
