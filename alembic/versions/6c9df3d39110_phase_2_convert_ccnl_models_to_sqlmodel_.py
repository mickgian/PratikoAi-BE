...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sector_code"],
            ["ccnl_sectors.sector_code"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index("idx_ccnl_agreements_dates", "ccnl_agreements", ["valid_from", "valid_to"], unique=False)
    op.create_index(
        "idx_ccnl_agreements_sector_valid", "ccnl_agreements", ["sector_code", "valid_from", "valid_to"], unique=False
    )
    ...
    op.create_index(
        "idx_leave_entitlements_agreement_type",
        "ccnl_leave_entitlements",
        ["agreement_id", "leave_type"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_notice_periods_agreement_category",
        "ccnl_notice_periods",
        ["agreement_id", "worker_category"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_salary_tables_agreement_level",
        "ccnl_salary_tables",
        ["agreement_id", "level_code", "geographic_area"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_special_allowances_agreement_type",
        "ccnl_special_allowances",
        ["agreement_id", "allowance_type"],
        unique=False,
    )
