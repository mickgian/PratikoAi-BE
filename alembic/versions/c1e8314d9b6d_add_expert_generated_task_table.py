...
revision: str = "c1e8314d9b6d"
down_revision: str | Sequence[str] | None = "9c4322e06e4d"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "decision_type",
            sa.Enum("SENTENZA", "ORDINANZA", "DECRETO", "MASSIMA", "ORIENTAMENTO", name="decisiontype"),
            nullable=False,
        ),
    ...
    op.create_index(op.f("ix_cassazione_decisions_decision_id"), "cassazione_decisions", ["decision_id"], unique=True)
    op.create_table(
        "compliance_checks",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "overall_status",
            sa.Enum("COMPLIANT", "NON_COMPLIANT", "WARNING", "NEEDS_REVIEW", "UNKNOWN", name="compliancestatus"),
            nullable=False,
        ),
    ...
    op.create_index("idx_compliance_date", "compliance_checks", ["check_date"], unique=False)
    op.create_index(
        "idx_compliance_followup", "compliance_checks", ["follow_up_required", "follow_up_date"], unique=False
    )
    op.create_index("idx_compliance_session", "compliance_checks", ["session_id"], unique=False)
    op.create_index("idx_compliance_status", "compliance_checks", ["overall_status"], unique=False)
    op.create_index("idx_compliance_type", "compliance_checks", ["check_type"], unique=False)
    op.create_index("idx_compliance_user", "compliance_checks", ["user_id"], unique=False)
    op.create_table(
    ...
    op.create_index("idx_source_authority", "italian_knowledge_sources", ["authority"], unique=False)
    op.create_index("idx_source_name", "italian_knowledge_sources", ["source_name"], unique=False)
    op.create_index("idx_source_reliability", "italian_knowledge_sources", ["reliability_score"], unique=False)
    op.create_index("idx_source_status", "italian_knowledge_sources", ["access_status"], unique=False)
    op.create_index("idx_source_type", "italian_knowledge_sources", ["source_type"], unique=False)
    op.create_table(
    ...
    op.create_index("idx_template_category", "italian_legal_templates", ["category", "subcategory"], unique=False)
    op.create_index("idx_template_code", "italian_legal_templates", ["template_code"], unique=False)
    op.create_index("idx_template_industry", "italian_legal_templates", ["industry_specific"], unique=False)
    op.create_index("idx_template_type", "italian_legal_templates", ["document_type"], unique=False)
    op.create_index("idx_template_validity", "italian_legal_templates", ["valid_from", "valid_to"], unique=False)
    op.create_table(
    ...
    op.create_index("idx_doc_authority", "italian_official_documents", ["authority"], unique=False)
    op.create_index("idx_doc_category", "italian_official_documents", ["category"], unique=False)
    op.create_index("idx_doc_collection_date", "italian_official_documents", ["collected_at"], unique=False)
    op.create_index("idx_doc_hash", "italian_official_documents", ["content_hash"], unique=False)
    op.create_index("idx_doc_id", "italian_official_documents", ["document_id"], unique=False)
    op.create_index("idx_doc_pub_date", "italian_official_documents", ["publication_date"], unique=False)
    op.create_index("idx_doc_status", "italian_official_documents", ["processing_status"], unique=False)
    op.create_table(
        "italian_regulations",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index("idx_regulation_authority", "italian_regulations", ["authority"], unique=False)
    op.create_index("idx_regulation_dates", "italian_regulations", ["enacted_date", "effective_date"], unique=False)
    op.create_index("idx_regulation_status", "italian_regulations", ["repealed_date"], unique=False)
    op.create_index(
    ...
    op.create_index("idx_tax_rate_code", "italian_tax_rates", ["tax_code"], unique=False)
    op.create_index("idx_tax_rate_location", "italian_tax_rates", ["region", "municipality"], unique=False)
    op.create_index("idx_tax_rate_type", "italian_tax_rates", ["tax_type"], unique=False)
    op.create_index("idx_tax_rate_validity", "italian_tax_rates", ["valid_from", "valid_to"], unique=False)
    op.create_table(
        "prompt_templates",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index("idx_tax_calc_date", "tax_calculations", ["calculation_date"], unique=False)
    op.create_index("idx_tax_calc_session", "tax_calculations", ["session_id"], unique=False)
    op.create_index("idx_tax_calc_type", "tax_calculations", ["calculation_type"], unique=False)
    op.create_index("idx_tax_calc_user", "tax_calculations", ["user_id"], unique=False)
    op.create_index("idx_tax_calc_year", "tax_calculations", ["tax_year"], unique=False)
    op.create_table(
        "webhook_events",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index("idx_webhook_created_at", "webhook_events", ["created_at"], unique=False)
    ...
    op.create_index("idx_webhook_stripe_event_id", "webhook_events", ["stripe_event_id"], unique=False)
    op.create_table(
        "cost_alerts",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(op.f("ix_cost_alerts_user_id"), "cost_alerts", ["user_id"], unique=False)
    op.create_table(
    ...
    op.create_index("idx_customer_stripe_id", "customers", ["stripe_customer_id"], unique=False)
    op.create_index("idx_customer_user_id", "customers", ["user_id"], unique=False)
    op.create_table(
    ...
    op.create_index(op.f("ix_documents_upload_timestamp"), "documents", ["upload_timestamp"], unique=False)
    ...
    op.create_table(
        ...
        sa.Column("plan_type", sa.Enum("TRIAL", "MONTHLY", "YEARLY", "ENTERPRISE", name="plantype"), nullable=False),
    ...
    op.create_index("idx_subscription_customer_id", "subscriptions", ["stripe_customer_id"], unique=False)
    ...
    op.create_table(
        ...
        sa.Column(
            "event_type",
            sa.Enum("LLM_QUERY", "LLM_STREAM", "CACHE_HIT", "CACHE_MISS", "API_REQUEST", name="usagetype"),
            nullable=False,
        ),
        sa.Column("timestamp", sa.DateTime(), nullable=False),
        ...
        sa.Column(
            "cost_category",
            sa.Enum("LLM_INFERENCE", "STORAGE", "COMPUTE", "BANDWIDTH", "THIRD_PARTY", name="costcategory"),
            nullable=True,
        ),
        sa.Column("response_time_ms", sa.Integer(), nullable=True),
        sa.Column("cache_hit", sa.Boolean(), nullable=True),
    ...
    op.create_index(op.f("ix_user_usage_summaries_date"), "user_usage_summaries", ["date"], unique=False)
    op.create_index(op.f("ix_user_usage_summaries_user_id"), "user_usage_summaries", ["user_id"], unique=False)
    op.create_table(
        "document_analyses",
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "SUCCEEDED", "FAILED", "CANCELED", "REFUNDED", name="paymentstatus"),
            nullable=False,
        ),
    ...
    op.create_index("idx_payment_stripe_intent_id", "payments", ["stripe_payment_intent_id"], unique=False)
    op.create_index("idx_payment_subscription_id", "payments", ["subscription_id"], unique=False)
    ...
    op.create_index("idx_invoice_subscription_id", "invoices", ["subscription_id"], unique=False)
    op.create_index("idx_invoice_user_id", "invoices", ["user_id"], unique=False)
    op.create_table(
        "rss_faq_impacts",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index("idx_expert_feedback_timestamp", "expert_feedback", ["feedback_timestamp"], unique=False)
    op.drop_constraint(op.f("expert_feedback_expert_id_fkey"), "expert_feedback", type_="foreignkey")
    op.create_foreign_key(None, "expert_feedback", "expert_profiles", ["expert_id"], ["id"])
    ...
    op.create_index("idx_expert_generated_tasks_created_at", "expert_generated_tasks", ["created_at"], unique=False)
    op.create_index("idx_expert_generated_tasks_expert_id", "expert_generated_tasks", ["expert_id"], unique=False)
    op.create_index("idx_expert_generated_tasks_feedback_id", "expert_generated_tasks", ["feedback_id"], unique=False)
    op.create_index(op.f("ix_expert_generated_tasks_task_id"), "expert_generated_tasks", ["task_id"], unique=True)
    op.drop_constraint(op.f("expert_generated_tasks_feedback_id_fkey"), "expert_generated_tasks", type_="foreignkey")
    op.create_foreign_key(None, "expert_generated_tasks", "expert_feedback", ["feedback_id"], ["id"])
    op.alter_column(
        "expert_profiles",
        "credentials",
        existing_type=postgresql.ARRAY(sa.TEXT()),
    ...
    op.create_foreign_key(None, "expert_profiles", "user", ["user_id"], ["id"])
...
def downgrade() -> None:
    ...
    op.create_index(op.f("idx_knowledge_publication_date"), "knowledge_items", ["publication_date"], unique=False)
    op.create_index(
        op.f("idx_ki_publication_date"),
        "knowledge_items",
        ["publication_date"],
    ...
    op.create_index(op.f("idx_feed_status_last_success"), "feed_status", ["last_success"], unique=False)
    op.alter_column(
        "feed_status",
        "updated_at",
        existing_type=postgresql.TIMESTAMP(timezone=True),
