...
def upgrade() -> None:
    ...
    op.drop_index(op.f("ix_expert_faq_candidates_query_signature"), table_name="expert_faq_candidates")
    ...
    op.drop_index(op.f("idx_feed_status_last_success"), table_name="feed_status")
    ...
    op.drop_index(op.f("idx_knowledge_publication_date"), table_name="knowledge_items")
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_expert_generated_tasks_task_id"), table_name="expert_generated_tasks")
    op.drop_index("idx_expert_generated_tasks_feedback_id", table_name="expert_generated_tasks")
    op.drop_index("idx_expert_generated_tasks_expert_id", table_name="expert_generated_tasks")
    op.drop_index("idx_expert_generated_tasks_created_at", table_name="expert_generated_tasks")
    ...
    op.drop_index("idx_expert_feedback_timestamp", table_name="expert_feedback")
    safe_create_index(
    ...
    op.drop_index("idx_rss_impacts_priority", table_name="rss_faq_impacts")
    op.drop_index("idx_rss_impacts_faq", table_name="rss_faq_impacts")
    op.drop_index("idx_rss_impacts_date", table_name="rss_faq_impacts")
    op.drop_table("rss_faq_impacts")
    op.drop_index("idx_invoice_user_id", table_name="invoices")
    ...
    op.drop_index("idx_invoice_period", table_name="invoices")
    op.drop_table("invoices")
    op.drop_index("idx_payment_user_id", table_name="payments")
    op.drop_index("idx_payment_subscription_id", table_name="payments")
    op.drop_index("idx_payment_stripe_intent_id", table_name="payments")
    op.drop_index("idx_payment_status", table_name="payments")
    op.drop_index("idx_payment_created_at", table_name="payments")
    op.drop_table("payments")
    op.drop_index("idx_generated_faqs_quality", table_name="generated_faqs")
    op.drop_index("idx_generated_faqs_performance", table_name="generated_faqs")
    op.drop_index("idx_generated_faqs_approval", table_name="generated_faqs")
    op.drop_table("generated_faqs")
    ...
    op.drop_index(op.f("ix_document_processing_jobs_expires_at"), table_name="document_processing_jobs")
    ...
    op.drop_index(op.f("ix_user_usage_summaries_user_id"), table_name="user_usage_summaries")
    op.drop_index(op.f("ix_user_usage_summaries_date"), table_name="user_usage_summaries")
    op.drop_table("user_usage_summaries")
    ...
    op.drop_index("idx_system_improvements_type", table_name="system_improvements")
    op.drop_index("idx_system_improvements_status", table_name="system_improvements")
    op.drop_index("idx_system_improvements_priority", table_name="system_improvements")
    op.drop_index("idx_system_improvements_pattern", table_name="system_improvements")
    op.drop_table("system_improvements")
    ...
    op.drop_table("knowledge_base_searches")
    ...
    op.drop_index(op.f("ix_faq_generation_jobs_celery_task_id"), table_name="faq_generation_jobs")
    op.drop_index("idx_faq_jobs_type", table_name="faq_generation_jobs")
    op.drop_index("idx_faq_jobs_status", table_name="faq_generation_jobs")
    op.drop_index("idx_faq_jobs_celery", table_name="faq_generation_jobs")
    op.drop_table("faq_generation_jobs")
    op.drop_index("idx_faq_candidates_status", table_name="faq_candidates")
    op.drop_index("idx_faq_candidates_roi", table_name="faq_candidates")
    op.drop_index("idx_faq_candidates_priority", table_name="faq_candidates")
    op.drop_table("faq_candidates")
    op.drop_table("export_tax_calculations")
    op.drop_table("export_document_analysis")
    op.drop_table("electronic_invoices")
    op.drop_index(op.f("ix_documents_user_id"), table_name="documents")
    op.drop_index(op.f("ix_documents_upload_timestamp"), table_name="documents")
    ...
    op.drop_index("idx_customer_user_id", table_name="customers")
    op.drop_index("idx_customer_stripe_id", table_name="customers")
    op.drop_index("idx_customer_email", table_name="customers")
    op.drop_table("customers")
    op.drop_index(op.f("ix_cost_optimization_suggestions_user_id"), table_name="cost_optimization_suggestions")
    op.drop_table("cost_optimization_suggestions")
    op.drop_index(op.f("ix_cost_alerts_user_id"), table_name="cost_alerts")
    op.drop_table("cost_alerts")
    op.drop_index("idx_webhook_stripe_event_id", table_name="webhook_events")
    ...
    op.drop_index("idx_webhook_created_at", table_name="webhook_events")
    op.drop_table("webhook_events")
    op.drop_index("idx_tax_calc_year", table_name="tax_calculations")
    op.drop_index("idx_tax_calc_user", table_name="tax_calculations")
    op.drop_index("idx_tax_calc_type", table_name="tax_calculations")
    op.drop_index("idx_tax_calc_session", table_name="tax_calculations")
    op.drop_index("idx_tax_calc_date", table_name="tax_calculations")
    ...
    op.drop_index(op.f("ix_query_clusters_normalized_form"), table_name="query_clusters")
    op.drop_index(op.f("ix_query_clusters_last_seen"), table_name="query_clusters")
    op.drop_index(op.f("ix_query_clusters_first_seen"), table_name="query_clusters")
    op.drop_index(op.f("ix_query_clusters_canonical_query"), table_name="query_clusters")
    op.drop_index("idx_query_clusters_quality", table_name="query_clusters")
    op.drop_index("idx_query_clusters_priority", table_name="query_clusters")
    op.drop_index("idx_query_clusters_cost", table_name="query_clusters")
    op.drop_table("query_clusters")
    op.drop_index("idx_quality_metrics_period", table_name="quality_metrics")
    op.drop_index("idx_quality_metrics_name_date", table_name="quality_metrics")
    op.drop_index("idx_quality_metrics_category", table_name="quality_metrics")
    op.drop_table("quality_metrics")
    op.drop_index("idx_prompt_templates_usage", table_name="prompt_templates")
    op.drop_index("idx_prompt_templates_quality", table_name="prompt_templates")
    ...
    op.drop_index("idx_tax_rate_validity", table_name="italian_tax_rates")
    op.drop_index("idx_tax_rate_type", table_name="italian_tax_rates")
    op.drop_index("idx_tax_rate_location", table_name="italian_tax_rates")
    op.drop_index("idx_tax_rate_code", table_name="italian_tax_rates")
    op.drop_table("italian_tax_rates")
    op.drop_index("idx_regulation_type_number", table_name="italian_regulations")
    op.drop_index("idx_regulation_subjects", table_name="italian_regulations", postgresql_using="gin")
    op.drop_index("idx_regulation_status", table_name="italian_regulations")
    op.drop_index("idx_regulation_dates", table_name="italian_regulations")
    op.drop_index("idx_regulation_authority", table_name="italian_regulations")
    op.drop_table("italian_regulations")
    op.drop_index("idx_doc_status", table_name="italian_official_documents")
    op.drop_index("idx_doc_pub_date", table_name="italian_official_documents")
    op.drop_index("idx_doc_id", table_name="italian_official_documents")
    op.drop_index("idx_doc_hash", table_name="italian_official_documents")
    op.drop_index("idx_doc_collection_date", table_name="italian_official_documents")
    op.drop_index("idx_doc_category", table_name="italian_official_documents")
    op.drop_index("idx_doc_authority", table_name="italian_official_documents")
    op.drop_table("italian_official_documents")
    op.drop_index("idx_template_validity", table_name="italian_legal_templates")
    op.drop_index("idx_template_type", table_name="italian_legal_templates")
    op.drop_index("idx_template_industry", table_name="italian_legal_templates")
    op.drop_index("idx_template_code", table_name="italian_legal_templates")
    op.drop_index("idx_template_category", table_name="italian_legal_templates")
    op.drop_table("italian_legal_templates")
    op.drop_index("idx_source_type", table_name="italian_knowledge_sources")
    op.drop_index("idx_source_status", table_name="italian_knowledge_sources")
    op.drop_index("idx_source_reliability", table_name="italian_knowledge_sources")
    op.drop_index("idx_source_name", table_name="italian_knowledge_sources")
    op.drop_index("idx_source_authority", table_name="italian_knowledge_sources")
    op.drop_table("italian_knowledge_sources")
    op.drop_table("faq_categories")
    op.drop_table("faq_analytics_summary")
    op.drop_index("idx_failure_patterns_type", table_name="failure_patterns")
    op.drop_index("idx_failure_patterns_resolved", table_name="failure_patterns")
    op.drop_index("idx_failure_patterns_impact", table_name="failure_patterns")
    op.drop_index("idx_failure_patterns_frequency", table_name="failure_patterns")
    op.drop_table("failure_patterns")
    op.drop_index("idx_expert_validations_target", table_name="expert_validations")
    op.drop_index("idx_expert_validations_status", table_name="expert_validations")
    op.drop_index("idx_expert_validations_query", table_name="expert_validations")
    op.drop_index("idx_expert_validations_complexity", table_name="expert_validations")
    op.drop_table("expert_validations")
    op.drop_table("document_collections")
    op.drop_index("idx_compliance_user", table_name="compliance_checks")
    ...
    op.drop_index("idx_compliance_session", table_name="compliance_checks")
    op.drop_index("idx_compliance_followup", table_name="compliance_checks")
    op.drop_index("idx_compliance_date", table_name="compliance_checks")
    op.drop_table("compliance_checks")
    op.drop_index(op.f("ix_cassazione_decisions_decision_id"), table_name="cassazione_decisions")
    op.drop_table("cassazione_decisions")
    # ### end Alembic commands ###
