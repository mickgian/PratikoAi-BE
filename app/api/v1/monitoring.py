...
async def get_prometheus_metrics():
    ...
    try:
        ...
        logger.debug(
            "prometheus_metrics_requested", 
            metrics_size=len(metrics_content)
        )
...
async def get_metrics_summary(
    ...
    try:
        from app.core.monitoring.metrics import (
            monthly_revenue, active_subscriptions, active_users,
            cache_hit_ratio, llm_cost_total
        )
