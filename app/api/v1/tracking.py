...
# NOTE: /stats/{communication_id} MUST be defined BEFORE /{tracking_type}/{token}
# because FastAPI matches routes in definition order, and the wildcard pattern
# would otherwise swallow /stats/... requests.
