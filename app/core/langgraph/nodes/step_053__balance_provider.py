...
def node_step_53(state: rag_types.RAGState) -> rag_types.RAGState:
    """Node wrapper for Step 53: Balance Provider.

    Delegates to the orchestrator and updates state with balanced provider selection.
    """
    ...
    with rag_types.rag_step_timer(STEP):
        ...
        result = orchestrators.step_53__balance_provider(ctx=dict(state))
        ...
        if isinstance(result, dict):
            ...
            state["route_strategy"] = "BALANCED"  # legacy field
