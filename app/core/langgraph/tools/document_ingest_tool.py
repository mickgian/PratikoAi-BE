...
class DocumentIngestInput(BaseModel):
    ...
    user_id: str = Field(
        description="User ID for tracking and audit purposes"
    )
...
class DocumentIngestTool(BaseTool):
    ...
    def _validate_attachment(self, attachment: Dict[str, Any], max_file_size: int, supported_types: List[str]) -> Optional[str]:
    ...
    async def _process_single_attachment(self, attachment: Dict[str, Any], user_id: str, session_id: str) -> Dict[str, Any]:
