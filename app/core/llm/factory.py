...
from app.core.llm.base import LLMProvider, LLMProviderType, LLMModelTier
...
class LLMFactory:
    ...
    def _route_cost_optimized(
        ...
        optimal_provider, _ = self.cost_calculator.find_optimal_provider(
            providers, messages, max_cost_eur
        )
    ...
    def _route_quality_first(
        ...
        try:
            ...
            logger.warning(
                "quality_requirements_not_met_fallback_to_cost",
            ...
            for provider in providers:
                if provider.provider_type == provider_type:
                    try:
                        ...
                        estimate = self.cost_calculator.calculate_cost_estimate(
                            provider, messages
                        )
