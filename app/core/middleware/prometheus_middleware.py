...
class PrometheusMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        try:
            ...
            status_code = 500
            logger.error("request_processing_error", method=method, path=path, error=str(e), exc_info=True)
            raise
            ...
            try:
                ...
                logger.error("request_metrics_tracking_failed", method=method, path=path, error=str(e))
