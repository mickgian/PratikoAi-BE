...
VAT_RATES_2024 = {
    VatCategory.STANDARD: {
        "rate": Decimal("22"),
        "description": "Standard VAT rate - most goods and services"
    },
...
CAPITAL_GAINS_TAX_2024 = {
    "financial": {
        "rate": Decimal("26"),
        "description": "Capital gains on financial instruments"
    },
    "real_estate": {
        "rate": Decimal("26"),
...
TAX_DEDUCTIONS_2024 = {
    ...
    "pension_contributions": {
        "max_amount": Decimal("5164.57"),
        "description": "Supplementary pension contributions"
    }
}
...
TAX_CALENDAR_2024 = {
    ...
    "vat_quarterly": [
        {
            "quarter": 1,
            "deadline": date(2024, 4, 16),
            "description": "Q1 VAT return"
        },
        {
            "quarter": 2,
            "deadline": date(2024, 7, 16),
            "description": "Q2 VAT return"
        },
        {
            "quarter": 3,
            "deadline": date(2024, 10, 16),
            "description": "Q3 VAT return"
        },
        {
            "quarter": 4,
    ...
    "imu_payments": [
        {
            "installment": 1,
            "deadline": date(2024, 6, 17),
            "description": "First IMU installment"
        },
        {
            "installment": 2,
            "deadline": date(2024, 12, 16),
            "description": "Second IMU installment (balance)"
        }
    ]
}
...
REGIONAL_SPECIAL_PROVISIONS = {
    "Trentino-Alto Adige": {
        "autonomous_province": True,
        "special_irpef_rates": True,
        "reduced_irap": True
    },
    "Valle d'Aosta": {
        "autonomous_region": True,
        "no_regional_surcharge": True,
        "reduced_irap": True
    },
    "Friuli-Venezia Giulia": {
        "autonomous_region": True,
        "reduced_regional_surcharge": True
    },
    "Sicilia": {
        "autonomous_region": True,
