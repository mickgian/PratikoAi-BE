...
def get_metalmeccanici_industria_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "C1", Decimal('1456.00'), 
                   thirteenth_month=True, fourteenth_month=False, valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "C2", Decimal('1658.00'),
                   thirteenth_month=True, fourteenth_month=True, valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "C3", Decimal('1842.00'),
                   thirteenth_month=True, fourteenth_month=True, valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "D1", Decimal('1923.00'),
                   thirteenth_month=True, fourteenth_month=True, valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "D2", Decimal('2184.00'),
                   thirteenth_month=True, fourteenth_month=True, valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "D3", Decimal('2456.00'),
                   thirteenth_month=True, fourteenth_month=True, valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "Q1", Decimal('2834.00'),
                   thirteenth_month=True, fourteenth_month=True, valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.METALMECCANICI_INDUSTRIA, "Q2", Decimal('3245.00'),
                   thirteenth_month=True, fourteenth_month=True, valid_from=date(2024, 1, 1))
    ]
...
def get_commercio_terziario_ccnl() -> CCNLAgreement:
    ...
    job_levels = [
        JobLevel("A1", "Addetto Vendite Base", WorkerCategory.OPERAIO, 
                "Addetto alle vendite con mansioni di base", 0),
        JobLevel("A2", "Addetto Vendite Qualificato", WorkerCategory.OPERAIO,
                "Addetto vendite con esperienza e clienti", 12),
        JobLevel("B1", "Impiegato Commerciale", WorkerCategory.IMPIEGATO,
                "Impiegato con funzioni commerciali e amministrative", 0),
        JobLevel("B2", "Impiegato Specializzato", WorkerCategory.IMPIEGATO,
                "Impiegato con specializzazione settoriale", 24,
                supervision_responsibilities=True),
        JobLevel("C1", "Capo Reparto", WorkerCategory.IMPIEGATO,
                "Responsabile di reparto con team", 36,
                supervision_responsibilities=True),
        JobLevel("D1", "Quadro Commerciale", WorkerCategory.QUADRO,
                "Quadro con responsabilità commerciali", 60,
                supervision_responsibilities=True)
    ]
    ...
    salary_tables = [
        ...
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "A1", Decimal('1380.00'), 
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True),
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "A2", Decimal('1485.00'),
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True),
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "B1", Decimal('1621.00'),
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True, fourteenth_month=True),
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "B2", Decimal('1834.00'),
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True, fourteenth_month=True),
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "C1", Decimal('2156.00'),
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True, fourteenth_month=True),
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "D1", Decimal('2598.00'),
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True, fourteenth_month=True),
        
        # North Italy (higher rates)
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "A1", Decimal('1420.00'),
                   geographic_area=GeographicArea.NORD, thirteenth_month=True),
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "B1", Decimal('1685.00'),
                   geographic_area=GeographicArea.NORD, thirteenth_month=True, fourteenth_month=True),
        
        # South Italy (slightly lower rates)
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "A1", Decimal('1340.00'),
                   geographic_area=GeographicArea.SUD, thirteenth_month=True),
        SalaryTable(CCNLSector.COMMERCIO_TERZIARIO, "B1", Decimal('1565.00'),
                   geographic_area=GeographicArea.SUD, thirteenth_month=True, fourteenth_month=True)
    ]
...
def get_edilizia_industria_ccnl() -> CCNLAgreement:
    ...
    job_levels = [
        JobLevel("A1", "Operaio Comune Edile", WorkerCategory.OPERAIO,
                "Operaio addetto a mansioni generiche del cantiere", 0),
        JobLevel("A2", "Operaio Qualificato", WorkerCategory.OPERAIO,
                "Operaio specializzato in specifiche lavorazioni edili", 12),
        JobLevel("A3", "Operaio Specializzato", WorkerCategory.OPERAIO,
                "Operaio altamente specializzato", 24),
        JobLevel("B1", "Capo Operaio", WorkerCategory.IMPIEGATO,
                "Responsabile squadra operai", 36, supervision_responsibilities=True),
        JobLevel("C1", "Impiegato Tecnico", WorkerCategory.IMPIEGATO,
                "Impiegato con funzioni tecniche", 0),
        JobLevel("D1", "Quadro Tecnico", WorkerCategory.QUADRO,
                "Quadro con responsabilità tecniche", 60)
    ]
    ...
    salary_tables = [
        ...
        SalaryTable(CCNLSector.EDILIZIA_INDUSTRIA, "B1", Decimal('2034.00'), thirteenth_month=True, fourteenth_month=True),
        SalaryTable(CCNLSector.EDILIZIA_INDUSTRIA, "C1", Decimal('2189.00'), thirteenth_month=True, fourteenth_month=True),
        SalaryTable(CCNLSector.EDILIZIA_INDUSTRIA, "D1", Decimal('2756.00'), thirteenth_month=True, fourteenth_month=True)
    ]
...
def get_pubblici_esercizi_ccnl() -> CCNLAgreement:
    ...
    job_levels = [
        JobLevel("1°", "Addetto ai Servizi", WorkerCategory.OPERAIO,
                "Cameriere, barista, addetto cucina di base", 0),
        JobLevel("2°", "Addetto Qualificato", WorkerCategory.OPERAIO,
                "Cameriere esperto, barista specializzato", 12),
        JobLevel("3°", "Addetto Specializzato", WorkerCategory.OPERAIO,
                "Sommelier, capo cameriere, cuoco", 24),
        JobLevel("4°", "Responsabile Servizio", WorkerCategory.IMPIEGATO,
                "Responsabile sala, responsabile cucina", 36,
                supervision_responsibilities=True),
        JobLevel("5°", "Quadro", WorkerCategory.QUADRO,
                "Direttore, responsabile generale", 60,
                supervision_responsibilities=True)
    ]
    ...
    salary_tables = [
        # National base rates
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "1°", Decimal('1342.00'), 
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True),
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "2°", Decimal('1456.00'), 
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True),
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "3°", Decimal('1612.00'), 
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True),
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "4°", Decimal('1834.00'), 
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True, fourteenth_month=True),
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "5°", Decimal('2456.00'), 
                   geographic_area=GeographicArea.NAZIONALE, thirteenth_month=True, fourteenth_month=True),
        
        # North Italy (higher tourism areas)
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "1°", Decimal('1395.00'), 
                   geographic_area=GeographicArea.NORD, thirteenth_month=True),
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "3°", Decimal('1678.00'), 
                   geographic_area=GeographicArea.NORD, thirteenth_month=True),
        
        # South Italy (tourism areas with seasonal differences)
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "1°", Decimal('1295.00'), 
                   geographic_area=GeographicArea.SUD, thirteenth_month=True),
        SalaryTable(CCNLSector.PUBBLICI_ESERCIZI, "2°", Decimal('1398.00'), 
                   geographic_area=GeographicArea.SUD, thirteenth_month=True)
    ]
...
def get_turismo_ccnl() -> CCNLAgreement:
    ...
    return CCNLAgreement(
        ...
        job_levels=[
            ...
            JobLevel("3°", "Responsabile Turni", WorkerCategory.IMPIEGATO, "Capo ricevimento", 24,
                    supervision_responsibilities=True)
        ],
        salary_tables=[
...
def get_trasporti_logistica_ccnl() -> CCNLAgreement:
    ...
    return CCNLAgreement(
        ...
        salary_tables=[
            ...
            SalaryTable(CCNLSector.TRASPORTI_LOGISTICA, "C", Decimal('1923.00'), thirteenth_month=True, fourteenth_month=True)
        ],
        working_hours=WorkingHours(
...
def get_chimici_farmaceutici_ccnl() -> CCNLAgreement:
    ...
    return CCNLAgreement(
        ...
        salary_tables=[
            ...
            SalaryTable(CCNLSector.CHIMICI_FARMACEUTICI, "V", Decimal('2034.00'), thirteenth_month=True, fourteenth_month=True),
            SalaryTable(CCNLSector.CHIMICI_FARMACEUTICI, "VI", Decimal('2456.00'), thirteenth_month=True, fourteenth_month=True)
        ],
        working_hours=WorkingHours(
...
def get_metalmeccanici_artigiani_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        ...
        SalaryTable(CCNLSector.METALMECCANICI_ARTIGIANI, "4°", Decimal('1834.00'), thirteenth_month=True, fourteenth_month=True),
        SalaryTable(CCNLSector.METALMECCANICI_ARTIGIANI, "5°", Decimal('2123.00'), thirteenth_month=True, fourteenth_month=True)
    ]
...
def get_edilizia_artigianato_ccnl() -> CCNLAgreement:
    ...
    return CCNLAgreement(
        ...
        job_levels=[
            ...
            JobLevel("2°", "Operaio Specializzato", WorkerCategory.OPERAIO, "Operaio con specializzazione tecnica", 12),
            JobLevel("3°", "Capo Squadra", WorkerCategory.OPERAIO, "Responsabile piccola squadra", 24,
                    supervision_responsibilities=True)
        ],
        salary_tables=[
        ...
        notice_periods=[
            NoticePerioD(CCNLSector.EDILIZIA_ARTIGIANATO, WorkerCategory.OPERAIO, 0, 999, 15)
        ]
    )
...
def validate_ccnl_data_completeness() -> Dict[str, Any]:
    ...
    required_components = [
        "job_levels", "salary_tables", "leave_entitlements", 
        "notice_periods", "working_hours"
    ]
    ...
    for ccnl in all_ccnl:
        ...
        for component in required_components:
            ...
            elif hasattr(component_data, '__len__') and len(component_data) == 0:
                missing_components.append(f"{ccnl.sector.value}.{component}")
                sector_missing.append(component)
            else:
