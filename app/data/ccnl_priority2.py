...
def get_telecomunicazioni_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.TELECOMUNICAZIONI, "4A", Decimal("1680.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.TELECOMUNICAZIONI, "5A", Decimal("2145.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.TELECOMUNICAZIONI, "6A", Decimal("2680.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.TELECOMUNICAZIONI, "7A", Decimal("3250.00"), valid_from=date(2024, 1, 1)),
    ]
...
def get_ict_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(
            CCNLSector.ICT, "1°", Decimal("1980.00"), GeographicArea.NORD, CompanySize.LARGE, date(2024, 1, 1)
        ),
        SalaryTable(
            CCNLSector.ICT, "2°", Decimal("2680.00"), GeographicArea.NORD, CompanySize.LARGE, date(2024, 1, 1)
        ),
        SalaryTable(
            CCNLSector.ICT, "3°", Decimal("3280.00"), GeographicArea.NORD, CompanySize.LARGE, date(2024, 1, 1)
        ),
        SalaryTable(
            CCNLSector.ICT, "4°", Decimal("4180.00"), GeographicArea.NORD, CompanySize.LARGE, date(2024, 1, 1)
        ),
    ]

    working_hours = WorkingHours(
        ccnl_sector=CCNLSector.ICT, ordinary_weekly_hours=38, flexible_hours_allowed=True, shift_work_allowed=False
    )
...
def get_call_center_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(
            CCNLSector.CALL_CENTER, "1°", Decimal("1250.00"), GeographicArea.SUD, CompanySize.LARGE, date(2024, 1, 1)
        ),
        SalaryTable(
            CCNLSector.CALL_CENTER, "2°", Decimal("1380.00"), GeographicArea.SUD, CompanySize.LARGE, date(2024, 1, 1)
        ),
        SalaryTable(
            CCNLSector.CALL_CENTER, "3°", Decimal("1580.00"), GeographicArea.SUD, CompanySize.LARGE, date(2024, 1, 1)
        ),
        SalaryTable(
            CCNLSector.CALL_CENTER, "4°", Decimal("1980.00"), GeographicArea.SUD, CompanySize.LARGE, date(2024, 1, 1)
        ),
    ]
