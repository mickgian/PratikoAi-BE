...
def get_sanita_privata_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.SANITA_PRIVATA, "OTA", Decimal("1420.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.SANITA_PRIVATA, "OSS", Decimal("1580.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.SANITA_PRIVATA, "INF", Decimal("1980.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.SANITA_PRIVATA, "COORD", Decimal("2480.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.SANITA_PRIVATA, leave_type=LeaveType.FERIE, base_annual_days=30),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.SANITA_PRIVATA, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=32
        ),
    ]
...
def get_case_di_cura_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.CASE_DI_CURA, "AUS", Decimal("1340.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.CASE_DI_CURA, "OSS", Decimal("1480.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.CASE_DI_CURA, "ASA", Decimal("1680.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.CASE_DI_CURA, "RESP", Decimal("2280.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.CASE_DI_CURA, leave_type=LeaveType.FERIE, base_annual_days=28),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.CASE_DI_CURA, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=30
        ),
    ]
...
def get_farmacie_private_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.FARMACIE_PRIVATE, "COMM", Decimal("1380.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.FARMACIE_PRIVATE, "FARM_ASS", Decimal("1780.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.FARMACIE_PRIVATE, "FARM_RESP", Decimal("2380.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.FARMACIE_PRIVATE, "TITUL", Decimal("3180.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.FARMACIE_PRIVATE, leave_type=LeaveType.FERIE, base_annual_days=26),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.FARMACIE_PRIVATE, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=28
        ),
    ]
...
def get_enti_locali_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.ENTI_LOCALI, "B1", Decimal("1520.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.ENTI_LOCALI, "C1", Decimal("1820.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.ENTI_LOCALI, "D1", Decimal("2420.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.ENTI_LOCALI, "DIR", Decimal("3820.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.ENTI_LOCALI, leave_type=LeaveType.FERIE, base_annual_days=32),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.ENTI_LOCALI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=35
        ),
    ]
...
def get_ministeri_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.MINISTERI, "B", Decimal("1720.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.MINISTERI, "C", Decimal("2120.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.MINISTERI, "D", Decimal("2820.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.MINISTERI, "DIR", Decimal("4820.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.MINISTERI, leave_type=LeaveType.FERIE, base_annual_days=35),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.MINISTERI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=40
        ),
    ]
...
def get_scuola_privata_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.SCUOLA_PRIVATA, "ATA", Decimal("1420.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.SCUOLA_PRIVATA, "DOC_PRIM", Decimal("1620.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.SCUOLA_PRIVATA, "DOC_SEC", Decimal("1820.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.SCUOLA_PRIVATA, "COORD", Decimal("2420.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        ...
        LeaveEntitlement(
            ccnl_sector=CCNLSector.SCUOLA_PRIVATA, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=25
        ),
    ]
...
def get_universita_private_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.UNIVERSITA_PRIVATE, "TAB", Decimal("1580.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.UNIVERSITA_PRIVATE, "RIC_TD", Decimal("2180.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.UNIVERSITA_PRIVATE, "PROF_ASS", Decimal("3180.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.UNIVERSITA_PRIVATE, "PROF_ORD", Decimal("4680.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.UNIVERSITA_PRIVATE, leave_type=LeaveType.FERIE, base_annual_days=32),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.UNIVERSITA_PRIVATE, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=30
        ),
    ]
...
def get_enti_di_ricerca_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.ENTI_DI_RICERCA, "TAR", Decimal("1680.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.ENTI_DI_RICERCA, "RICJR", Decimal("2280.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.ENTI_DI_RICERCA, "RICSR", Decimal("3280.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.ENTI_DI_RICERCA, "DIRETT", Decimal("4880.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.ENTI_DI_RICERCA, leave_type=LeaveType.FERIE, base_annual_days=34),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.ENTI_DI_RICERCA, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=32
        ),
    ]
