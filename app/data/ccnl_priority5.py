...
def get_giornalisti_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.GIORNALISTI, "PRAT", Decimal("1680.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.GIORNALISTI, "GIOR", Decimal("2480.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.GIORNALISTI, "GIOR_SPEC", Decimal("3480.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.GIORNALISTI, "CAPOREDATT", Decimal("4880.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.GIORNALISTI, leave_type=LeaveType.FERIE, base_annual_days=30),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.GIORNALISTI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=25
        ),
    ]
...
def get_grafici_editoriali_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.GRAFICI_EDITORIALI, "GRAF_JR", Decimal("1580.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.GRAFICI_EDITORIALI, "GRAF_EDIT", Decimal("2180.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.GRAFICI_EDITORIALI, "ART_DIR", Decimal("3180.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.GRAFICI_EDITORIALI, "RESP_GRAF", Decimal("4180.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.GRAFICI_EDITORIALI, leave_type=LeaveType.FERIE, base_annual_days=28),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.GRAFICI_EDITORIALI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=24
        ),
    ]
...
def get_cinema_audiovisivo_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.CINEMA_AUDIOVISIVO, "ASSIST", Decimal("1780.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.CINEMA_AUDIOVISIVO, "TECNICO", Decimal("2580.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.CINEMA_AUDIOVISIVO, "REGISTA_ASS", Decimal("3780.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.CINEMA_AUDIOVISIVO, "PRODUTTORE", Decimal("5580.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.CINEMA_AUDIOVISIVO, leave_type=LeaveType.FERIE, base_annual_days=26),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.CINEMA_AUDIOVISIVO, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=22
        ),
    ]
...
def get_teatro_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.TEATRO, "TECNICO_SC", Decimal("1480.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.TEATRO, "ATTORE", Decimal("2280.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.TEATRO, "REGISTA_TEAT", Decimal("3480.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.TEATRO, "DIRETT_TEAT", Decimal("4980.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        ...
        LeaveEntitlement(ccnl_sector=CCNLSector.TEATRO, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=26),
    ]
...
def get_radio_tv_private_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.RADIO_TV_PRIVATE, "OPER_TECN", Decimal("1880.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.RADIO_TV_PRIVATE, "CONDUTTORE", Decimal("2980.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.RADIO_TV_PRIVATE, "AUTORE", Decimal("3980.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.RADIO_TV_PRIVATE, "DIRETT_PROG", Decimal("5980.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.RADIO_TV_PRIVATE, leave_type=LeaveType.FERIE, base_annual_days=29),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.RADIO_TV_PRIVATE, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=26
        ),
    ]
