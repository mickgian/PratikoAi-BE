...
def get_autotrasporto_merci_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.AUTOTRASPORTO_MERCI, "AUTISTA", Decimal("1750.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTOTRASPORTO_MERCI, "AUTISTA_SPEC", Decimal("2050.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTOTRASPORTO_MERCI, "CAPOSQUADRA", Decimal("2850.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTOTRASPORTO_MERCI, "DISP_TRASP", Decimal("4200.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.AUTOTRASPORTO_MERCI, leave_type=LeaveType.FERIE, base_annual_days=26),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.AUTOTRASPORTO_MERCI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=20
        ),
    ]
...
def get_autonoleggio_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.AUTONOLEGGIO, "OPER_RENT", Decimal("1650.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTONOLEGGIO, "RESP_FLOTTA", Decimal("2200.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTONOLEGGIO, "COORD_AREA", Decimal("3200.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTONOLEGGIO, "DIRETT_REG", Decimal("4800.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.AUTONOLEGGIO, leave_type=LeaveType.FERIE, base_annual_days=26),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.AUTONOLEGGIO, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=18
        ),
    ]
...
def get_autorimesse_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.AUTORIMESSE, "CUSTODE", Decimal("1500.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTORIMESSE, "PARCH_SPEC", Decimal("1700.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTORIMESSE, "CAPO_TURNO", Decimal("2100.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.AUTORIMESSE, "RESP_STRUTTURA", Decimal("2800.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.AUTORIMESSE, leave_type=LeaveType.FERIE, base_annual_days=26),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.AUTORIMESSE, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=16
        ),
    ]
...
def get_pompe_funebri_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.POMPE_FUNEBRI, "OPER_FUN", Decimal("1800.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.POMPE_FUNEBRI, "NETTURS_SPEC", Decimal("2200.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.POMPE_FUNEBRI, "COORD_SERV", Decimal("2800.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.POMPE_FUNEBRI, "DIRETT_AGE", Decimal("4000.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.POMPE_FUNEBRI, leave_type=LeaveType.FERIE, base_annual_days=26),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.POMPE_FUNEBRI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=20
        ),
    ]
...
def get_acconciatura_estetica_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.ACCONCIATURA_ESTETICA, "APPRENDISTA", Decimal("1200.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.ACCONCIATURA_ESTETICA, "OPER_QUALIF", Decimal("1650.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(
            CCNLSector.ACCONCIATURA_ESTETICA, "SPECIAL_SENIOR", Decimal("2300.00"), valid_from=date(2024, 1, 1)
        ),
        SalaryTable(CCNLSector.ACCONCIATURA_ESTETICA, "RESP_SALON", Decimal("3200.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(
            ccnl_sector=CCNLSector.ACCONCIATURA_ESTETICA, leave_type=LeaveType.FERIE, base_annual_days=26
        ),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.ACCONCIATURA_ESTETICA, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=18
        ),
    ]
...
def get_impianti_sportivi_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.IMPIANTI_SPORTIVI, "MANUTENTORE", Decimal("1650.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.IMPIANTI_SPORTIVI, "ISTRUTTORE", Decimal("1950.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.IMPIANTI_SPORTIVI, "RESP_ATTIVITA", Decimal("2800.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.IMPIANTI_SPORTIVI, "DIRETT_CENTRO", Decimal("4200.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.IMPIANTI_SPORTIVI, leave_type=LeaveType.FERIE, base_annual_days=26),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.IMPIANTI_SPORTIVI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=18
        ),
    ]
...
def get_dirigenti_industria_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.DIRIGENTI_INDUSTRIA, "QUADRO_SUP", Decimal("5500.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.DIRIGENTI_INDUSTRIA, "DIR_JUNIOR", Decimal("8500.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.DIRIGENTI_INDUSTRIA, "DIR_SENIOR", Decimal("12000.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.DIRIGENTI_INDUSTRIA, "DIR_GENERALE", Decimal("18000.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.DIRIGENTI_INDUSTRIA, leave_type=LeaveType.FERIE, base_annual_days=30),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.DIRIGENTI_INDUSTRIA, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=24
        ),
    ]
...
def get_dirigenti_commercio_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.DIRIGENTI_COMMERCIO, "AREA_MANAGER", Decimal("4800.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.DIRIGENTI_COMMERCIO, "DIR_COMM_JR", Decimal("7500.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.DIRIGENTI_COMMERCIO, "DIR_COMM_SR", Decimal("11000.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.DIRIGENTI_COMMERCIO, "DIR_MARKETING", Decimal("10500.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.DIRIGENTI_COMMERCIO, leave_type=LeaveType.FERIE, base_annual_days=28),
        LeaveEntitlement(
            ccnl_sector=CCNLSector.DIRIGENTI_COMMERCIO, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=20
        ),
    ]
...
def get_quadri_ccnl() -> CCNLAgreement:
    ...
    salary_tables = [
        SalaryTable(CCNLSector.QUADRI, "QUADRO_JR", Decimal("3500.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.QUADRI, "QUADRO_INTERMEDIO", Decimal("4200.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.QUADRI, "QUADRO_SENIOR", Decimal("5200.00"), valid_from=date(2024, 1, 1)),
        SalaryTable(CCNLSector.QUADRI, "QUADRO_SPECIALIST", Decimal("4800.00"), valid_from=date(2024, 1, 1)),
    ]
    ...
    leave_entitlements = [
        LeaveEntitlement(ccnl_sector=CCNLSector.QUADRI, leave_type=LeaveType.FERIE, base_annual_days=28),
        LeaveEntitlement(ccnl_sector=CCNLSector.QUADRI, leave_type=LeaveType.PERMESSI_RETRIBUITI, base_annual_days=20),
    ]
        ...
        for agreement in all_agreements:
            ...
            if components_complete:
                ...
                validation_result["missing_components"].append(
                    {"sector": agreement.sector.value, "missing": missing_for_sector}
                )
