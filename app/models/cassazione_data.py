...
class LegalPrinciple:
    ...
    def _extract_keywords(text: str) -> List[str]:
        ...
        legal_terms = [
            ...
            "risarcimento", "danno", "colpa", "dolo", "obbligazione", "diritto", "dovere",
            "iva", "imposta", "tributo", "lavoro", "licenziamento", "tfr"
        ]
...
class Citation:
    ...
    court_section: Optional[CourtSection] = None
...
class ScrapingResult:
    ...
    def is_valid(self) -> bool:
        """Validate the result."""
        return (
            self.decisions_processed <= self.decisions_found and
            self.decisions_saved <= self.decisions_processed and
            self.errors >= 0
        )
