...
from sqlalchemy import (
    ...
    Enum as SQLEnum, Text, Numeric, BigInteger, Date, JSON
)
...
class DataExportRequest(Base):
    ...
    def can_retry(self) -> bool:
        ...
        return (
            self.status == ExportStatus.FAILED and
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "time_until_expiry_hours": round(self.time_until_expiry.total_seconds() / 3600, 1) if self.time_until_expiry else 0,
