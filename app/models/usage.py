...
class UsageEvent(SQLModel, table=True):
    ...
    # Cost information
    cost_eur: float | None = Field(default=None, description="Cost in EUR")
    cost_category: CostCategory | None = Field(default=None, description="Cost category")

    # Performance metrics
    response_time_ms: int | None = Field(default=None, description="Response time in milliseconds")
    cache_hit: bool | None = Field(default=None, description="Whether request was served from cache")
    ...
    ip_address: str | None = Field(default=None, description="Client IP address (anonymized)")
...
class UserUsageSummary(SQLModel, table=True):
    ...
    model_usage: str | None = Field(default=None, description="JSON object with model usage stats")
    provider_usage: str | None = Field(default=None, description="JSON object with provider usage stats")
...
class CostAlert(SQLModel, table=True):
    ...
    notification_type: str | None = Field(default=None, description="Type of notification sent")

    # Additional data
    extra_data: str | None = Field(default=None, description="Additional metadata as JSON")
...
class UsageQuota(SQLModel, table=True):
    ...
    blocked_until: datetime | None = Field(default=None, description="Blocked until this time")
...
class CostOptimizationSuggestion(SQLModel, table=True):
    ...
    # Results tracking
    actual_savings_eur: float | None = Field(default=None, description="Actual savings achieved")
    effectiveness_score: float | None = Field(default=None, description="How effective the suggestion was")

    # Metadata
    extra_data: str | None = Field(default=None, description="Additional data as JSON")
