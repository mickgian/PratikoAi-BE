...
async def step_59__check_cache(
    *, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs
    ...
    with rag_step_timer(
        59, "RAG.cache.langgraphagent.get.cached.llm.response.check.for.cached.response", "CheckCache", stage="start"
    ):
        ...
        try:
            ...
            for msg in messages_list:
                if isinstance(msg, dict):
                    formatted_messages.append(
                        Message(role=msg.get("role", "user"), content=str(msg.get("content", "")))
                    )
                elif hasattr(msg, "role") and hasattr(msg, "content"):
                    formatted_messages.append(msg)
                else:
                    formatted_messages.append(Message(role="user", content=str(msg)))
            ...
            if cache_enabled and formatted_messages:
                query_hash = cache_service._generate_query_hash(
                    messages=formatted_messages, model=model, temperature=temperature
                )
...
async def step_61__gen_hash(*, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs) -> Any:
    ...
    with rag_step_timer(
        ...
        try:
            ...
            key_components = {
                ...
                "epochs": {"kb_epoch": kb_epoch, "golden_epoch": golden_epoch, "ccnl_epoch": ccnl_epoch},
...
async def step_62__cache_hit(*, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs) -> Any:
...
async def step_63__track_cache_hit(
    *, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs
) -> Any:
    ...
    with rag_step_timer(63, "RAG.cache.usagetracker.track.track.cache.hit", "TrackCacheHit", stage="start"):
        ...
        try:
            ...
            if cached_response:
                ...
                llm_response = LLMResponse(
                    content="[cached response]", model=model, provider=provider, tokens_used=0, cost_estimate=0.0
                )
...
async def step_65__log_cache_hit(
    *, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs
) -> Any:
...
async def step_66__return_cached(
    *, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs
) -> Any:
...
async def step_68__cache_response(
    *, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs
) -> Any:
    ...
    with rag_step_timer(68, "RAG.cache.cacheservice.cache.response.store.in.redis", "CacheResponse", stage="start"):
        ...
        if error:
            ...
            logger.error(
                log_message,
                extra={"cache_event": "storage_failed", "error": error, "model": model, "provider": provider},
            )
        else:
...
async def _cache_feedback_with_ttl(ctx: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        feedback_data = {
            ...
            if hasattr(feedback_record.feedback_type, "value")
            else str(feedback_record.feedback_type),
            "category": feedback_record.category.value
            if feedback_record.category and hasattr(feedback_record.category, "value")
            else (feedback_record.category if feedback_record.category else None),
            ...
            if hasattr(feedback_record, "feedback_timestamp")
...
async def step_125__cache_feedback(
    *, messages: list[Any] | None = None, ctx: dict[str, Any] | None = None, **kwargs
) -> Any:
        ...
        result.update(
            {
                ...
                "cache_timestamp": datetime.now(UTC).isoformat(),
            }
        )
