...
async def step_4__gdprlog(*, messages: Optional[List[Any]] = None, ctx: Optional[Dict[str, Any]] = None, **kwargs) -> Any:
    """
    ...
    with rag_step_timer(4, 'RAG.privacy.gdprcompliance.record.processing.log.data.processing', 'GDPRLog', stage="start"):
        rag_step_log(step=4, step_id='RAG.privacy.gdprcompliance.record.processing.log.data.processing', node_label='GDPRLog',
                     category='privacy', type='process', processing_stage="started")
        ...
        try:
            ...
            if not validation_result:
                ...
                rag_step_log(step=4, step_id='RAG.privacy.gdprcompliance.record.processing.log.data.processing',
                           node_label='GDPRLog', processing_stage="completed", error="missing_validation_result",
                           gdpr_logged=False, processing_recorded=False, request_id=request_id)
                return result
            ...
            if not is_valid:
                ...
                rag_step_log(step=4, step_id='RAG.privacy.gdprcompliance.record.processing.log.data.processing',
                           node_label='GDPRLog', processing_stage="completed", gdpr_logged=False,
                           processing_recorded=False, skip_reason='invalid_request', request_id=request_id)
                return result
            ...
            if not session or not session.user_id:
                ...
                rag_step_log(step=4, step_id='RAG.privacy.gdprcompliance.record.processing.log.data.processing',
                           node_label='GDPRLog', processing_stage="completed", error="missing_session_or_user",
                           gdpr_logged=False, processing_recorded=False, request_id=request_id)
                return result
...
async def step_6__privacy_check(*, messages: Optional[List[Any]] = None, ctx: Optional[Dict[str, Any]] = None, **kwargs) -> Any:
    """
    ...
    with rag_step_timer(6, 'RAG.privacy.privacy.anonymize.requests.enabled', 'PrivacyCheck', stage="start"):
        rag_step_log(step=6, step_id='RAG.privacy.privacy.anonymize.requests.enabled', node_label='PrivacyCheck',
                     category='privacy', type='decision', processing_stage="started")
        ...
        try:
            ...
            if privacy_enabled:
                ...
                logger.info(
                    ...
                    extra={
                        'privacy_event': 'anonymization_enabled',
                ...
                logger.info(
                    ...
                    request_id=request_id,
                    extra={
                        'privacy_event': 'anonymization_disabled',
                        'next_step': 'InitAgent'
                    }
                )
...
async def step_7__anonymize_text(*, messages: Optional[List[Any]] = None, ctx: Optional[Dict[str, Any]] = None, **kwargs) -> Any:
    """
        ...
        try:
            ...
            if not validated_request or not validated_request.get('messages'):
                ...
                rag_step_log(step=7, step_id='RAG.privacy.anonymizer.anonymize.text.anonymize.pii',
                           node_label='AnonymizeText', processing_stage="completed", error="missing_messages",
                           anonymization_completed=False, request_id=request_id)
                return result
            ...
            result['pii_matches'] = [{'pii_type': match.pii_type.value, 'anonymized': True} for match in all_pii_matches]
            result['ready_for_workflow_init'] = True
