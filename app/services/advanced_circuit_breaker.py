...
class AdvancedCircuitBreakerManager:
    ...
    async def get_health_metrics(self) -> dict[str, Any]:
        ...
        metrics = {"total_providers": len(self.circuits), "providers": {}, "overall_health": 0.0, "alerts": []}
        ...
        for provider, circuit in self.circuits.items():
            ...
            provider_metrics = {
                ...
                "last_success_time": circuit["last_success_time"].isoformat()
                ...
                alerts.append(
                    {
                        ...
                        "timestamp": datetime.utcnow().isoformat(),
                        "details": {"state": circuit["state"].value, "failure_count": circuit["failure_count"]},
                    }
                )
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        for _provider, circuit in self.circuits.items():
            # State distribution
            state = circuit["state"].value
