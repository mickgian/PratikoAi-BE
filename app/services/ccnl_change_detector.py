...
class CCNLChangeDetector:
    ...
    def detect_salary_changes(self, old_salary_data: Dict[str, Any], 
                             new_salary_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Detected salary changes: {len(changes['increased'])} increases, "
    ...
    def detect_working_conditions_changes(self, old_conditions: Dict[str, Any], 
                                         new_conditions: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Detected working conditions changes: {len(changes['modified'])} modified, "
    ...
    def detect_leave_provision_changes(self, old_leave: Dict[str, Any], 
                                      new_leave: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def calculate_significance_score(self, changes: Dict[str, Any]) -> float:
        ...
        try:
            ...
            if salary_increases:
                ...
                for level, increase_info in salary_increases.items():
    ...
    def analyze_salary_progression(self, old_wages: Dict[str, Any], 
                                  new_wages: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if increases:
                ...
                if len(set(round(inc, 0) for inc in increases)) > 2:
    ...
    def detect_structural_changes(self, old_data: Dict[str, Any], 
        ...
        try:
            ...
            if salary_increases:
                ...
                if levels_count == 1:
                    ...
                    avg_percentage = sum(info.get("percentage", 0) for info in salary_increases.values()) / levels_count
                    summary_parts.append(f"Salary increases averaging {avg_percentage:.1f}% across {levels_count} levels")
