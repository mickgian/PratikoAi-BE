...
from app.services.domain_action_classifier import DomainActionClassifier, Domain, Action
...
class CCNLIntegrationService:
    ...
    async def process_ccnl_query(
        ...
        try:
            ...
            is_ccnl_query = (
                classification.domain == Domain.LABOR and
                (classification.action == Action.CCNL_QUERY or 
        ...
        try:
            return {
                ...
                "supported_sectors": [
                    ...
                    "chimico", "alimentare", "trasporti", "bancario", "assicurazioni"
                ],
