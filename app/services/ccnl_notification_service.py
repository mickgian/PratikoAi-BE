...
class CCNLNotificationService:
    ...
    def _initialize_templates(self) -> Dict[str, NotificationTemplate]:
        ...
        templates = {
            ...
            "expiry_warning": NotificationTemplate(
                ...
                message_template="The {ccnl_name} will expire on {expiry_date}. "
                                "Monitor for renewal negotiations.",
    ...
    def send_notification(self, notification: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for channel in channels:
                channel_results = self._send_via_channel(
                    notification, channel, affected_users
                )
            ...
            logger.info(f"Sent notification {notification_id} to {total_sent} recipients "
                       f"via {len(channels)} channels")
    ...
    def _send_via_channel(self, notification: Dict[str, Any], 
                         channel: str, users: List[str]) -> Dict[str, Any]:
