...
from app.models.ccnl_update_models import CCNLDatabase, CCNLVersion, CCNLChangeLog, ChangeType
...
class CCNLVersionManager:
    ...
    def get_current_version(self, ccnl_id: UUID) -> Optional[CCNLVersion]:
    ...
    def create_change_log(self, ccnl_id: UUID, old_version: CCNLVersion, 
                         new_version: CCNLVersion, change_type: ChangeType) -> CCNLChangeLog:
