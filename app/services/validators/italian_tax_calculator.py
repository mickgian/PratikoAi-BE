...
class TaxResult:
    ...
    gross_amount_vat: Optional[Decimal] = None
...
class ItalianTaxCalculator:
    ...
    def calculate_complete_individual_taxes(
        ...
        return {
            ...
            'regional_tax': {
                'amount': regional_tax.quantize(Decimal('0.01')),
                'rate': regional_rate
            },
            'municipal_tax': {
                'amount': municipal_tax.quantize(Decimal('0.01')),
                'rate': municipal_rate
            },
            'total_tax': {
