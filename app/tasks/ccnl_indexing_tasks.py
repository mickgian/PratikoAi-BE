...
# Initialize Celery
celery_app = Celery("ccnl_indexing", broker=settings.CELERY_BROKER_URL, backend=settings.CELERY_RESULT_BACKEND)
...
async def cleanup_old_cache() -> dict[str, Any]:
    ...
    try:
        ...
        result = {"status": "success", "entries_cleaned": 0, "timestamp": datetime.utcnow().isoformat()}
