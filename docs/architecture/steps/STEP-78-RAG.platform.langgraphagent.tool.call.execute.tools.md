...
Top candidates:
1) app/core/langgraph/graph.py:1014 — app.core.langgraph.graph.LangGraphAgent._route_tool_check (score 0.32)
   Evidence: Score 0.32, Route from ToolCheck node.
2) app/core/langgraph/graph.py:1021 — app.core.langgraph.graph.LangGraphAgent._route_tool_type (score 0.32)
   Evidence: Score 0.32, Route from ToolType node based on tool type.
3) app/core/langgraph/graph.py:1094 — app.core.langgraph.graph.LangGraphAgent._route_from_tool_check (score 0.32)
   Evidence: Score 0.32, Route from ToolCheck node.
4) app/core/langgraph/graph.py:1101 — app.core.langgraph.graph.LangGraphAgent._route_from_tool_type (score 0.32)
   Evidence: Score 0.32, Route from ToolType node based on tool type.
5) app/core/langgraph/graph.py:226 — app.core.langgraph.graph.LangGraphAgent.__init__ (score 0.31)
