...
| DEV-238 to DEV-240 | Phase 9.6: Quality & Monitoring |
| DEV-241 | Phase 9.7: Frontend UI (Reasoning Display) |
...
- **Unlocks:** DEV-238 (Monitoring dashboard)
...
<strong>Priority:</strong> LOW | <strong>Effort:</strong> 6h | <strong>Status:</strong> ✅ COMPLETED (2025-01-04)<br>
...
**Priority:** LOW | **Effort:** 6h | **Status:** ✅ COMPLETED (2025-01-04)
...
**Acceptance Criteria:**
- [x] Tests written BEFORE implementation (TDD)
- [x] paragraph_id in source metadata
- [x] source_excerpt in actions
- [x] UI can show paragraph tooltip
...
<details>
<summary>
<h3>DEV-241: Create Reasoning Trace UI Component</h3>
<strong>Priority:</strong> MEDIUM | <strong>Effort:</strong> 6h | <strong>Status:</strong> COMPLETED<br>
Reasoning traces and Tree of Thoughts logic are generated by the backend (DEV-214, DEV-223) but hidd...
</summary>


### DEV-241: Create Reasoning Trace UI Component
...
**Priority:** MEDIUM | **Effort:** 6h | **Status:** COMPLETED
...
- Created `src/components/chat/ReasoningTrace.tsx` - Expandable UI component
- Created `src/components/chat/__tests__/ReasoningTrace.test.tsx` - 33 TDD tests (100% pass)
- Features implemented:
  - Expandable/collapsible "Visualizza Ragionamento" trigger
  - Display of tema_identificato, fonti_utilizzate, elementi_chiave, conclusione
  - Confidence level badges (alta/media/bassa)
  - Risk warning display with red styling
  - Italian localization throughout
  - PratikoAI color palette (blu-petrolio, grigio-tortora, avorio)
  - Accessibility (ARIA labels, keyboard navigation)
  - Performance optimized with React.memo
  - Integration with SourceCitation component
...
| 9.6: Quality & Monitoring | DEV-238 to DEV-240 | 9h | LOW |
| 9.7: Frontend UI | DEV-241 | 6h | MEDIUM |
| **Total** | **32 tasks** | **~125h** | |

**Agent Assignment Summary:**
| Agent | Primary Tasks | Support Tasks |
|-------|---------------|---------------|
| @ezio | 28 tasks | 1 task (API support for DEV-241) |
| @livia | 1 task (DEV-241) | - |
