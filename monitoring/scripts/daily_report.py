...
class DailyReportGenerator:
    ...
    def generate_recommendations(self, cost_summary: Dict, revenue_summary: Dict, 
                               performance_summary: Dict, alert_summary: Dict) -> List[str]:
        ...
        if revenue_summary["mrr_progress_percent"] < 40:
            recommendations.append(
                "📊 MRR progress is below 40% of €25k target. Accelerate growth initiatives."
            )
        ...
        if revenue_summary["new_signups_24h"] == 0:
            recommendations.append(
                "👥 No new signups in 24h. Check marketing campaigns and signup flow."
            )
    ...
    def create_key_metrics(self, cost_summary: Dict, revenue_summary: Dict, 
                          performance_summary: Dict) -> List[MetricSummary]:
...
class ReportSender:
    ...
    @staticmethod
    def send_webhook(report: DailyReport, webhook_url: str, webhook_secret: Optional[str] = None):
