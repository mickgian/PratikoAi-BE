...
class MonitoringDemo:
    ...
    def simulate_user_session(self, user: DemoUser, duration_minutes: int = None) -> Dict[str, Any]:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if call_num % 10 == 0 and call_num > 0:
                        ...
                        logger.debug(f"  {user.user_id}: {call_num}/{total_calls} calls, €{total_cost:.3f} cost, {elapsed:.1f}s elapsed")
        ...
        logger.info(f"✅ Session completed for {user.user_id}: {api_calls_made} calls, €{total_cost:.3f} cost, {session_duration:.1f}s")
    ...
    def simulate_business_operations(self) -> Dict[str, Any]:
        ...
        logger.info(f"✅ Business operations simulated:")
    ...
    def demonstrate_cost_optimization(self) -> Dict[str, Any]:
        ...
        logger.info(f"✅ Cost optimization analysis:")
    ...
    def run_concurrent_demo(self, duration_minutes: int = 10, scenario: str = "mixed") -> Dict[str, Any]:
        ...
        avg_success_rate = sum(r["success_rate"] for r in session_results) / len(session_results) if session_results else 0
    ...
    def run_interactive_demo(self):
        ...
        triggered_alerts = self.trigger_demo_alerts("mixed")
...
def main():
    ...
    parser.add_argument("--scenario", choices=["mixed", "high-cost", "performance", "business"], 
                       default="mixed", help="Demo scenario type")
