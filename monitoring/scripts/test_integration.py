...
class MonitoringSystemTester:
    ...
    def test_service_availability(self) -> Dict[str, Any]:
        ...
        return {
            "status": "passed",
            "details": "All monitoring services are available"
        }
    ...
    def test_prometheus_metrics_collection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            app_metrics_response = requests.get(f"{self.prometheus_url}/api/v1/query",
                                              params={"query": "http_request_duration_seconds_count"}, timeout=10)
            ...
            return {
                "status": "failed",
                "details": "Failed to query Prometheus",
                "error": str(e)
            }
    ...
    def test_grafana_dashboards(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                auth = ("admin", "admin")
                dashboards_response = requests.get(f"{self.grafana_url}/api/search?type=dash-db",
            ...
            return {
                "status": "failed",
                "details": "Failed to connect to Grafana",
                "error": str(e)
            }
    ...
    def test_alert_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "failed",
                "details": "Failed to test alert system",
                "error": str(e)
            }
    ...
    def test_automation_scripts(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "passed",
                "details": "Automation scripts executed successfully"
            }
            ...
            return {
                "status": "failed",
                "details": "Failed to test automation scripts",
                "error": str(e)
            }
    ...
    def test_data_persistence(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = requests.get(f"{self.prometheus_url}/api/v1/query",
                                  params={"query": "prometheus_tsdb_symbol_table_size_bytes"}, timeout=10)
            
            if response.status_code != 200:
                return {
                    "status": "warning",
                    "details": "Could not test data persistence - Prometheus query failed"
                }
            ...
            if not data["data"]["result"]:
                return {
                    "status": "warning", 
                    "details": "Could not test data persistence - no TSDB metrics found"
                }
            
            # Check if we have historical data (more than just current scrape)
            range_response = requests.get(f"{self.prometheus_url}/api/v1/query_range",
                                        params={
                                            "query": "up",
            ...
            if range_response.status_code == 200:
                ...
                if range_data["data"]["result"]:
                    ...
                    values_count = len(range_data["data"]["result"][0]["values"]) if range_data["data"]["result"] else 0
                    ...
                    if values_count > 1:
                        ...
                        return {
                            "status": "warning",
                            "details": "Data persistence uncertain - limited historical data"
                        }
            
            return {
                "status": "warning",
                "details": "Data persistence test inconclusive"
            }
    ...
    def test_business_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "failed",
                "details": "Failed to test business metrics",
                "error": str(e)
            }
    ...
    def test_performance_load(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "failed",
                "details": "Performance load test failed",
                "error": str(e)
            }
