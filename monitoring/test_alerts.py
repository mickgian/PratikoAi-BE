...
class AlertTester:
    ...
    def simulate_low_cache_hit_ratio(self) -> bool:
        ...
        try:
            ...
            for i in range(20):
                ...
                requests.get(
                    f"{self.app_url}/api/v1/test",
                    params={"unique": unique_param},
                    timeout=5
                )
                if i % 5 == 0:
    ...
    def verify_notification_channels(self) -> bool:
        ...
        try:
            with open("monitoring/grafana/provisioning/notifiers/notification_channels.yml", "r") as f:
                config = f.read()
...
def main():
    ...
    parser.add_argument(
        ...
        help="PratikoAI application URL"
    )
