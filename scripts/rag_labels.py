...
def main() -> int:
    ...
    ap.add_argument(
        "--with-steps", action="store_true", help="Also create step/{n} labels for all steps in rag_steps.yml"
    )
    ...
    sprints = [
        "sprint/1-core",
        "sprint/2-retrieval",
        "sprint/3-providers-cache",
        "sprint/4-doc-ingest-I",
        "sprint/5-doc-ingest-II",
        "sprint/6-golden",
        "sprint/7-kb-rss",
        "sprint/8-classify-facts",
        "sprint/9-response-streaming",
        "sprint/10-feedback",
        "sprint/11-platform-privacy",
    ]
    for s in sprints:
