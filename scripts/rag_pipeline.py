...
def main():
    ...
    parser.add_argument("--create-issues", action="store_true", help="Create GitHub issues after backlog generation")
    ...
    parser.add_argument("--skip-audit", action="store_true", help="Skip audit step, only generate backlog")
