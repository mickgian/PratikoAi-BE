...
import { ArrowLeft, Brain, Shield, Lock, FileText, Users, Eye, Download, Trash2, Edit } from 'lucide-react'
  ...
  const complianceAreas = [
    {
      ...
      compliance: 95,
      status: 'Conforme',
      description: 'Tutti i trattamenti di dati personali sono basati su fondamenti giuridici validi secondo l\'Art. 6 GDPR.',
      details: [
    ...
    },
    {
      ...
      compliance: 92,
      status: 'Conforme',
      description: 'Implementazione completa di tutti i diritti GDPR con procedure automatizzate.',
      details: [
    ...
    },
    {
      ...
      compliance: 98,
      status: 'Conforme',
      description: 'Misure tecniche e organizzative avanzate per la protezione dei dati personali.',
      details: [
    ...
    },
    {
      ...
      compliance: 90,
      status: 'Conforme',
      description: 'Informazioni chiare e accessibili sul trattamento dei dati personali.',
      details: [
  ...
  const userRights = [
    {
      ...
      icon: Eye,
      description: 'Ottenere conferma che i tuoi dati sono trattati e ricevere copia dei dati',
    ...
    },
    {
      ...
      icon: Edit,
      description: 'Correggere dati personali inesatti o completare dati incompleti',
    ...
    },
    {
      ...
      icon: Trash2,
      description: 'Richiedere la cancellazione dei tuoi dati personali ("diritto all\'oblio")',
    ...
    },
    {
      ...
      icon: Download,
      description: 'Ricevere i tuoi dati in formato strutturato e trasmetterli ad altro titolare',
      action: 'Esporta Dati',
      timeframe: '30 giorni'
    }
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          >
            La nostra conformità al Regolamento Generale sulla Protezione dei Dati
          </motion.p>
        ...
        >
          <div className="bg-white border border-[#C4BDB4]/20 rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-[#2A5D67] mb-2">
              Stato della Conformità GDPR
            </h2>
            <p className="text-[#1E293B] mb-6">
              Monitoraggio continuo della nostra compliance al Regolamento Europeo
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {complianceAreas.map((area, index) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-[#2A5D67] mb-2">{area.title}</h3>
                  <div className="space-y-2">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
                        className="bg-[#2A5D67] h-2 rounded-full transition-all duration-300"
                        style={{ width: `${area.compliance}%` }}
                      ></div>
                    </div>
                    <p className="text-sm text-[#1E293B]">{area.compliance}%</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {complianceAreas.map((area, index) => (
            ...
            >
              <div className="bg-white border border-[#C4BDB4]/20 rounded-xl p-8 shadow-sm h-full">
                <div className="flex items-center space-x-3 text-[#2A5D67] mb-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-[#1E293B] max-w-2xl mx-auto">
              Esercita i tuoi diritti in modo semplice e rapido. Tutte le richieste sono gestite 
              secondo i tempi previsti dal GDPR.
            </p>
          </div>
                ...
                <div className="bg-white border border-[#C4BDB4]/20 rounded-xl shadow-sm hover:shadow-lg transition-all duration-200">
                  <div className="p-6">
                    <div className="flex items-center space-x-3 text-[#2A5D67] mb-4">
                      ...
                      <h3 className="text-xl font-bold">{userRight.right}</h3>
                    </div>
                    <p className="text-[#1E293B] mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="text-sm text-[#1E293B]">
                        <strong>Tempo di risposta:</strong> {userRight.timeframe}
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
        ...
        >
          <div className="bg-white border border-[#C4BDB4]/20 rounded-xl p-8 shadow-sm">
            ...
            <p className="text-[#1E293B] mb-6">
              Le nostre misure tecniche e organizzative per la protezione dei dati
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-4">
                <h4 className="font-semibold text-[#2A5D67]">Misure Tecniche</h4>
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-[#2A5D67]">Misure Organizzative</h4>
                <ul className="space-y-2 text-sm text-[#1E293B]">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-[#2A5D67]">Certificazioni</h4>
                <ul className="space-y-2 text-sm text-[#1E293B]">
        ...
        >
          ...
          <p className="text-[#1E293B] mb-6 max-w-2xl mx-auto">
            Per qualsiasi domanda sui tuoi diritti GDPR, sulla nostra conformità o per esercitare 
            i tuoi diritti, contatta direttamente il nostro DPO.
          </p>

          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="bg-white rounded-lg p-4 border border-[#C4BDB4]/20">
              <h4 className="font-semibold text-[#2A5D67] mb-2">Contatti DPO</h4>
              <div className="text-[#1E293B] space-y-1 text-sm">
                <p><strong>Dott.ssa Maria Rossi</strong></p>
            ...
            <div className="bg-white rounded-lg p-4 border border-[#C4BDB4]/20">
              <h4 className="font-semibold text-[#2A5D67] mb-2">Autorità di Controllo</h4>
              <div className="text-[#1E293B] space-y-1 text-sm">
        ...
        >
          <p>
            ...
            Conforme al GDPR (Regolamento UE 2016/679) e al Codice Privacy italiano (D.Lgs. 196/2003)
          </p>
        </motion.div>
      </motion.div>
    </div>
