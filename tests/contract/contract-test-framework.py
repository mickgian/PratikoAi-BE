...
class APIContractValidator:
    ...
    def load_spec(self, version: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def validate_endpoint(self, method: str, path: str, 
                              request_data: Optional[Dict] = None,
                              expected_status: int = 200) -> List[ContractViolation]:
    ...
    def _find_path_in_spec(self, spec: Dict[str, Any], path: str) -> Optional[Dict[str, Any]]:
    ...
    def _validate_response_headers(self, response: httpx.Response, operation: Dict[str, Any],
                                 violations: List[ContractViolation], endpoint: str):
        ...
        for path, path_item in paths.items():
            for method, operation in path_item.items():
                ...
                try:
                    ...
                    elif any(v.severity in [ContractViolationSeverity.CRITICAL, ContractViolationSeverity.MAJOR] 
                            for v in violations):
...
class CrossVersionCompatibilityTester:
    ...
    def __init__(self, current_service_url: str, previous_service_url: Optional[str] = None):
    ...
    def _find_breaking_changes(self, old_spec: Dict[str, Any], 
                              new_spec: Dict[str, Any]) -> List[ContractViolation]:
                ...
                for old_param in old_params:
                    ...
                    new_param = next(
                        (p for p in new_params 
                         if p.get('name') == old_param.get('name') 
                         and p.get('in') == old_param.get('in')),
                        None
                    )
...
class ContractTestRunner:
    ...
    async def run_all_tests(self) -> Dict[str, Any]:
        ...
        if previous_url := self.config.get('previous_version_url'):
            ...
            compatibility_tester = CrossVersionCompatibilityTester(
