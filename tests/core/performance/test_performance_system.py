...
from app.core.performance.cdn_integration import CacheControl, CDNProvider
from app.core.performance.performance_monitor import PerformanceAlert, RequestMetrics
from app.core.performance.response_compressor import CompressionStats, CompressionType
...
class TestDatabaseOptimizer:
    ...
    async def test_monitor_query_aggregation(self):
        ...
        for i in range(5):
            ...
            await database_optimizer.monitor_query(query=query, execution_time=execution_time, rows_affected=10 + i)

        # Find the query stats
        query_stats = list(database_optimizer.query_stats.values())
        aggregated_stats = next((stats for stats in query_stats if "PRODUCTS" in stats.query_text), None)
...
class TestResponseCompressor:
    ...
    def test_should_compress_json(self):
        ...
        should_compress, compression_type = response_compressor.should_compress(content, content_type, accept_encoding)
    ...
    def test_optimize_json_payload(self):
        ...
        data = {
            ...
            "empty_list": [],
            "items": [{"id": 1, "name": "Item 1", "deleted": None}, {"id": 2, "name": "Item 2", "deleted": False}],
        }
...
class TestCDNManager:
    ...
    async def test_record_cdn_metrics(self):
        ...
        cdn_manager.generate_asset_url("https://example.com/test.js", "application/javascript")
    ...
    def test_purge_asset_cache(self):
        ...
        cdn_manager.generate_asset_url("https://example.com/image1.jpg", "image/jpeg")
        cdn_manager.generate_asset_url("https://example.com/script.js", "application/javascript")
...
class TestPerformanceIntegration:
    ...
    async def test_end_to_end_performance_monitoring(self):
        ...
        query_hash = await database_optimizer.monitor_query(query=query, execution_time=0.3, rows_affected=150)
        ...
        cdn_manager.generate_asset_url("/static/app.js", "application/javascript")
