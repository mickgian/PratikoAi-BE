...
from app.core.security.security_monitor import ThreatLevel, ResponseAction
...
class TestRequestSigner:
    ...
    def test_generate_signature(self):
        ...
        signature = request_signer.generate_signature(
    ...
    def test_verify_signature_valid(self):
        ...
        is_valid = request_signer.verify_signature(
            method, path, body, timestamp, signature, secret_key
        )
    ...
    def test_verify_signature_invalid(self):
        ...
        is_valid = request_signer.verify_signature(
            method, path, body, timestamp, invalid_signature, secret_key
        )
    ...
    def test_verify_signature_expired_timestamp(self):
        ...
        signature = request_signer.generate_signature(
            method, path, body, old_timestamp, secret_key
        )
        
        is_valid = request_signer.verify_signature(
            method, path, body, old_timestamp, signature, secret_key
        )
    ...
    async def test_sign_outgoing_request(self):
        ...
        headers = await request_signer.sign_outgoing_request(
            method, url, body
        )
...
class TestSecurityMonitor:
    ...
    async def test_process_security_event_signature_failures(self):
        ...
        for i in range(21):  # Threshold is 20
            threat = await security_monitor.process_security_event(
                event_type=SecurityEventType.SIGNATURE_FAILED,
                ip_address=ip_address,
