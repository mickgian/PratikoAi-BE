...
class ItalianTaxTestDataGenerator:
    ...
    def __init__(self):
        ...
        self.tax_codes = {
            "IRPEF": {
                "acconto_prima_rata": "4001",
                "acconto_seconda_rata": "4033", 
                "saldo": "4031"
            },
            "IRES": {
                "acconto_prima_rata": "2003",
                "acconto_seconda_rata": "2004",
                "saldo": "2001"
            },
            "IVA": {
                "mensile": "6001",
    ...
    def generate_rss_updates(self, count: int = 20) -> List[Dict[str, Any]]:
        ...
        for _ in range(count):
            ...
            content_vars = {
                "tax": tax, "year": year, "month": month, "reason": reason, "topic": topic,
    ...
    def _generate_professional_query(self, prof_type: str, complexity: str, expertise: List[str]) -> Dict[str, Any]:
        ...
        if complexity == "simple":
            templates = [
                f"Scadenze {topic} 2024",
                f"Come calcolare {topic}",
                f"Documenti necessari {topic}"
            ]
            expected_cost = 0.003
            expected_time = 1.0
...
def get_random_queries(count: int, complexity: Optional[str] = None) -> List[Dict[str, Any]]:
