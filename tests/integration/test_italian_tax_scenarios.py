...
class TestItalianTaxProfessionalWorkflows:
    ...
    async def test_commercialista_daily_workflow(self, integration_test_environment):
        ...
        client_calculations = [
            {
                "query": "IRPEF per SRL con fatturato €250.000",
                "client_id": "client_srl_001",
                "complexity": "medium"
            },
            {
        ...
        for calc in client_calculations:
            ...
            assert calc_response["success"] == True
        ...
        for query in afternoon_research:
            ...
            assert any(ref in research_response["answer"].lower() 
                      for ref in ["tuir", "codice civile", "decreto", "circolare"])
    ...
    async def test_caf_operator_workflow(self, integration_test_environment):
        ...
        caf_start_time = datetime.utcnow()
    ...
    async def test_startup_consultant_workflow(self, integration_test_environment):
        ...
        startup_scenarios = [
            ...
            {
                "query": "Patent box per software house",
            ...
            {
                "query": "Incentivi fiscali R&D startup",
                "startup_stage": "development",
                "complexity": "medium"
            }
        ]
