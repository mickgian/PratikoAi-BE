...
class TestNodeWrapperDelegation:
    ...
    async def test_node_step_1_delegation(self):
        ...
        with patch('app.core.langgraph.nodes.step_001__validate_request.step_1__validate_request', new_callable=AsyncMock) as mock_orchestrator:
    ...
    async def test_async_node_step_6_delegation(self):
        ...
        with patch('app.core.langgraph.nodes.step_006__privacy_check.step_6__privacy_check', new_callable=AsyncMock) as mock_orchestrator:
            with patch('app.core.langgraph.types.logger'):
    ...
    async def test_logging_calls(self):
        ...
        with patch('app.core.langgraph.nodes.step_001__validate_request.step_1__validate_request', new_callable=AsyncMock) as mock_orchestrator:
            with patch('app.core.langgraph.nodes.step_001__validate_request.rag_step_log') as mock_log:
