...
class TestNodeStep42:
    ...
    async def test_node_step_42_sufficient_confidence(self):
        ...
        with (
            patch(
                "app.core.langgraph.nodes.step_042__class_confidence.step_42__class_confidence", new_callable=AsyncMock
    ...
    async def test_node_step_42_no_classification(self):
        ...
        with (
            ...
            initial_state = RAGState({"request_id": "test-no-class-789"})
            ...
            initial_state = RAGState(
                {
                    ...
                    "classification": {"domain": "hr", "confidence": 0.75},
