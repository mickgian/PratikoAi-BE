...
from app.services.italian_knowledge import ItalianTaxCalculator, ItalianLegalService, italian_knowledge_service
from app.models.italian_data import (
    TaxType, DocumentType, ComplianceStatus,
    ItalianTaxRate, ItalianLegalTemplate, TaxCalculation, ComplianceCheck
)
...
class TestItalianLegalService:
    ...
    async def test_get_tax_rates(self, mock_db):
        ...
        mock_db.get_db.return_value.__aenter__.return_value.execute.return_value.scalars.return_value.all.return_value = [mock_rate]
    ...
    async def test_get_legal_template(self, mock_db):
        ...
        mock_db.get_db.return_value.__aenter__.return_value.execute.return_value.scalar_one_or_none.return_value = mock_template
    ...
    async def test_search_regulations(self, mock_db):
        ...
        mock_db.get_db.return_value.__aenter__.return_value.execute.return_value.scalars.return_value.all.return_value = [mock_regulation]
