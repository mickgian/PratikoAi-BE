...
class TestAtomicFactsExtractor:
    ...
    @pytest.mark.parametrize("query,expected_amounts,expected_currency", [
    ...
    @pytest.mark.parametrize("query,expected_percentages", [
        # Percentage formats
    ...
    @pytest.mark.parametrize("query,expected_dates", [
    ...
    @pytest.mark.parametrize("query,expected_relative_dates", [
    ...
    @pytest.mark.parametrize("query,expected_tax_years", [
    ...
    @pytest.mark.parametrize("query,expected_durations", [
    ...
    @pytest.mark.parametrize("query,expected_tax_codes", [
    ...
    def test_tax_code_extraction(self, extractor, query, expected_tax_codes):
        ...
        tax_codes = [le.identifier for le in facts.legal_entities if le.entity_type in ["codice_fiscale", "partita_iva"]]
        assert tax_codes == expected_tax_codes

    @pytest.mark.parametrize("query,expected_company_types", [
    ...
    @pytest.mark.parametrize("query,expected_legal_refs", [
    ...
    @pytest.mark.parametrize("query,expected_ccnl_sectors", [
    ...
    @pytest.mark.parametrize("query,expected_job_levels", [
        ("operaio livello 5", ["5"]),
    ...
    @pytest.mark.parametrize("query,expected_contract_types", [
    ...
    def test_contract_type_extraction(self, extractor, query, expected_contract_types):
        ...
        contract_types = [pc.contract_type for pc in facts.professional_categories if pc.category_type == "contract_type"]
        assert contract_types == expected_contract_types

    # === GEOGRAPHIC INFORMATION EXTRACTION TESTS ===
    
    @pytest.mark.parametrize("query,expected_regions", [
    ...
    @pytest.mark.parametrize("query,expected_cities", [
    ...
    @pytest.mark.parametrize("query,expected_areas", [
    ...
    @pytest.mark.parametrize("input_number,expected_decimal", [
        ("1.000,50", 1000.5),
        ("50.000", 50000.0),
        ("1,5", 1.5),
        ("1000", 1000.0),
    ...
    @pytest.mark.parametrize("input_date,expected_iso", [
    ...
    @pytest.mark.parametrize("input_entity,expected_canonical", [
        ("s.r.l.", "SRL"),
...
class TestAtomicFactsDataModels:
    ...
    def test_atomic_facts_model(self):
        ...
        facts.monetary_amounts.append(
            MonetaryAmount(amount=1000.0, currency="EUR", confidence=0.95)
        )
...
def expected_extractions():
    ...
    return [
        ...
        {
            "monetary_amounts": [45000.0],
            "dates": [{"tax_year": 2023}],
            "legal_entities": [{"document_type": "IRPEF"}]
        },
