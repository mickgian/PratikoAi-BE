...
from app.models.cassazione import (
    ...
    CassazioneSearchQuery, extract_legal_keywords, classify_precedent_value,
    determine_related_sectors
)
from app.services.data_sources.cassazione_source import (
    CassazioneDataSource, extract_decision_citations, analyze_jurisprudence_consistency
)
...
class TestCassazioneDataSource:
    ...
    async def test_cassazione_initialization(self):
        ...
        expected_endpoints = [
            "civil_decisions", "labor_decisions", "united_sections", 
            "recent_decisions", "legal_principles", "advanced_search"
        ]
...
class TestCassazioneModels:
    ...
    def test_legal_keyword_extraction(self):
        ...
        expected_keywords = [
            "contratto collettivo", "licenziamento", "giusta causa"
        ]
...
class TestCassazioneIntegrationWithManager:
    ...
    async def test_cassazione_comprehensive_search(self):
        ...
        government_sources = [s for s in sources_searched if s in ["cassazione", "ministry_labor", "cnel_official", "inps"]]
...
class TestCassazioneDataQuality:
    ...
    async def test_sector_coverage_accuracy(self):
        ...
        test_cases = [
            ...
            {
                "text": "contratto edilizia costruzioni cantieri",
                "expected_sector": CCNLSector.EDILIZIA_INDUSTRIA
            },
            {
                "text": "commercio distribuzione negozi vendita",
                "expected_sector": CCNLSector.COMMERCIO_TERZIARIO
            },
            {
                "text": "sanità cliniche ospedali medici",
                "expected_sector": CCNLSector.SANITA_PRIVATA
            }
        ]
        ...
        for test_case in test_cases:
            ...
            assert test_case["expected_sector"] in sectors, \
