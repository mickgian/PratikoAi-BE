...
class TestLegalPrincipleModel:
    ...
    def test_principle_categorization(self):
        ...
        principle = LegalPrinciple(
            text="Il contratto deve essere interpretato secondo buona fede",
...
class TestDataModelIntegration:
    ...
    def test_decision_with_all_components(self):
        ...
        principles = [
            LegalPrinciple(
                text="L'amministratore risponde solo in caso di colpa grave",
                confidence_score=Decimal('0.90')
            ),
            LegalPrinciple(
                text="È necessario il nesso causale tra condotta e danno",
