    ...
    def test_salary_table_db_creation(self):
        ...
        salary_db = SalaryTableDB(
            ...
            additional_allowances={
                "indennita_anzianita": Decimal('50.00'),
                "premio_presenza": Decimal('25.00')
            },
...
class TestSpecialAllowanceDB:
    ...
    def test_allowance_monthly_calculation(self):
        ...
        monthly_allowance = SpecialAllowanceDB(
            agreement_id=1,
            allowance_type="premio_produzione",
...
class TestCCNLDatabaseIntegration:
    ...
    async def test_create_complete_ccnl_agreement(self):
        ...
        leave_entitlements = [
            ...
            LeaveEntitlementDB(
                agreement_id=1,
                leave_type="permessi_retribuiti",
                base_annual_hours=64
            ),
            LeaveEntitlementDB(
                agreement_id=1,
                leave_type="rol_ex_festivita",
    ...
    async def test_ccnl_database_queries(self):
        ...
        applicable_allowances = [
            a for a in test_allowances 
            if not a.applicable_job_levels or "C2" in a.applicable_job_levels
        ]
...
class TestCCNLDatabasePersistence:
    ...
    async def test_query_ccnl_agreements_by_sector(self):
        ...
        with pytest.assume_mock_database():
            ...
            current_agreements = [
                a for a in mock_agreements 
                if a.is_currently_valid()
            ]
    ...
    async def test_ccnl_data_migration(self):
        ...
        agreement = CCNLAgreementDB(
            sector_code=external_data["sector"],
            name=external_data["agreement_name"],
            valid_from=date(2024, 1, 1)
        )
