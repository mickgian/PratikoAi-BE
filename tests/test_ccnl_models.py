    ...
    def test_salary_with_allowances(self):
        ...
        salary_table = SalaryTable(
            ...
            additional_allowances={
                "indennita_trasporto": Decimal('150.00'),
                "indennita_turno": Decimal('80.00')
            }
        )
...
class TestOvertimeRulesModel:
    ...
    def test_overtime_calculation(self):
        ...
        overtime_pay = overtime.calculate_overtime_pay(
...
class TestCCNLCalculatorIntegration:
    ...
    def test_calculate_notice_period(self):
        ...
        notice_1_year = calculator.get_notice_period(
            worker_category=WorkerCategory.IMPIEGATO,
            seniority_months=12
        )
        assert notice_1_year == 15
        
        notice_5_years = calculator.get_notice_period(
            worker_category=WorkerCategory.IMPIEGATO,
            seniority_months=60
        )
    ...
    def test_calculate_leave_entitlement(self):
        ...
        leave_2_years = calculator.calculate_annual_leave(
            leave_type=LeaveType.FERIE,
            seniority_months=24
        )
        assert leave_2_years == 22  # Base entitlement
        
        leave_7_years = calculator.calculate_annual_leave(
            leave_type=LeaveType.FERIE,
            seniority_months=84
        )
