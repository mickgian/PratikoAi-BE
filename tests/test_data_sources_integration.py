...
from app.services.data_sources.base_source import (
    DataSourceInfo, DataSourceType, DataSourceStatus, UpdateFrequency,
    CCNLDocument, DataSourceQuery, DataSourceRegistry
)
...
class TestCNELDataSource:
    ...
    def test_cnel_date_extraction(self):
        ...
        test_cases = [
            "Contratto del 15/03/2024",
            "CCNL 2024",
            "Accordo 15 marzo 2024",
            "Rinnovo 2024-03-15"
        ]
...
class TestUnionDataSources:
    ...
    def test_union_document_extraction(self):
        ...
        for title, expected_sector in test_titles:
...
class TestEmployerDataSources:
    ...
    def test_all_employer_sources_creation(self):
        ...
        employer_classes = [
            ConfindustriaDataSource, ConfcommercioDataSource, 
            ConfartigianatoDataSource, ConfapiDataSource
        ]
...
class TestDataSourcesManager:
    ...
    def test_document_relevance_calculation(self):
        ...
        query = DataSourceQuery(
            sectors=[CCNLSector.COMMERCIO_TERZIARIO],
            document_types=["renewal"],
            keywords=["rinnovo", "commercio"]
        )
...
class TestDataSourceIntegration:
    ...
    def test_data_source_reliability_scores(self):
        ...
        for source in sources:
            ...
            assert 0.7 <= reliability <= 1.0, f"Reliability {reliability} out of range for {source.source_info.source_id}"
...
class TestErrorHandling:
    ...
    def test_empty_search_results(self):
        ...
        query = DataSourceQuery(
            sectors=[],
            keywords=["nonexistent_very_specific_term_xyz"],
            max_results=10
        )
...
class TestPerformanceConsiderations:
    ...
    def test_rate_limiting_configuration(self):
        ...
        for source in sources:
            ...
            assert rate_limit is None or (10 <= rate_limit <= 1000), \
