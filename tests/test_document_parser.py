...
class TestDocumentParser:
    ...
    def test_excel_balance_sheet_parsing(self, parser, sample_excel_data):
        ...
        try:
            ...
            total_liab_equity = (
                result.current_liabilities["2023"]
    ...
    def test_excel_income_statement_parsing(self, parser, sample_excel_data):
        ...
        try:
            ...
            revenue_growth_2023 = ((result.revenue["2023"] - result.revenue["2022"]) / result.revenue["2022"]) * 100
    ...
    def test_excel_multi_sheet_parsing(self, parser):
        ...
        try:
            ...
            balance_sheet = next(
                (fs for fs in result.financial_statements if fs.document_type == DocumentType.BALANCE_SHEET), None
            )
            income_statement = next(
                (fs for fs in result.financial_statements if fs.document_type == DocumentType.INCOME_STATEMENT), None
            )
...
6000,Operating Expenses,65000.00,"""
    ...
    def test_document_validation_financial_consistency(self, parser, sample_excel_data):
        ...
        inconsistent_data["balance_sheet"]["data"][4] = [
            "Total Assets",
            "1900000",
            "1800000",
            "1600000",
        ...
        try:
            ...
            balance_error = next(
                (err for err in consistency_check.inconsistencies if "balance" in err.error_type.lower()), None
            )
    ...
    def test_document_validation_data_quality_assessment(self, parser):
        ...
        try:
            ...
            expected_deductions = (
                poor_quality_data["missing_values"]
    ...
    def test_document_parsing_corrupted_file(self, parser):
        ...
        try:
            ...
            assert (
                "corrupted" in result.errors[0].error_message.lower()
                or "invalid" in result.errors[0].error_message.lower()
            )
