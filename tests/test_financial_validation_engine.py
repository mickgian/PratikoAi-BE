...
class TestFinancialValidationEngine:
    ...
    def comprehensive_validation_request(self):
        ...
        return ValidationRequest(
            ...
            tasks=[
                ...
                ValidationTask(
                    ...
                    input_data={
                        ...
                        "income_statement": {"revenue": Decimal("3000000"), "net_income": Decimal("300000")},
                    },
                    priority="medium",
                ),
                ValidationTask(
            ...
            context=ValidationContext(language="it", region="italy", currency="EUR", regulation_year=2024),
        )
    ...
    def test_sequential_pipeline_execution(self, engine, comprehensive_validation_request):
        ...
        # Act
        pipeline_result = engine.execute_pipeline(comprehensive_validation_request, execution_mode="sequential")
    ...
    def test_parallel_pipeline_execution(self, engine, comprehensive_validation_request):
        ...
        # Act
        pipeline_result = engine.execute_pipeline(comprehensive_validation_request, execution_mode="parallel")
        ...
        cross_val_request = ValidationRequest(
            ...
            tasks=[
                ValidationTask(
                    ...
                    task_type=TaskType.TAX_CALCULATION,
                    input_data={"gross_income": Decimal("40000"), "calculation_method": "standard"},
                ),
                ValidationTask(
                    task_id="tax_calc_alternative",
                    task_type=TaskType.TAX_CALCULATION,
                    input_data={"gross_income": Decimal("40000"), "calculation_method": "detailed"},
                ),
            ],
        ...
        def custom_italian_tax_rule(tax_data):
            ...
            if tax_data.get("effective_rate", 0) > Decimal("0.50"):
                return ValidationWarning(
                    code="HIGH_TAX_RATE", message="Effective tax rate exceeds 50%", severity="medium"
                )
            return None
    ...
    def test_engine_performance_high_volume(self, engine):
        ...
        high_volume_request = ValidationRequest(request_id="high_vol_001", tasks=high_volume_tasks)
