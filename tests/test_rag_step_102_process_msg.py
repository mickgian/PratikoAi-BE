...
class TestRAGStep102ProcessMsg:
    ...
    async def test_step_102_converts_messages_to_dict_format(self, mock_rag_log):
        ...
        ctx = {
            ...
            "conversation_metadata": {"turn_count": 2, "total_tokens": 150},
    ...
    async def test_step_102_filters_out_system_and_tool_messages(self, mock_rag_log):
        ...
        ctx = {"messages": messages, "response_source": "tool_results", "request_id": "test-102-filter"}
    ...
    async def test_step_102_handles_empty_content_messages(self, mock_rag_log):
        ...
        ctx = {"messages": messages, "request_id": "test-102-empty"}
    ...
    async def test_step_102_preserves_message_content_and_order(self, mock_rag_log):
        ...
        ctx = {"messages": messages, "request_id": "test-102-preserve"}
    ...
    async def test_step_102_handles_complex_message_types(self, mock_rag_log):
        ...
        ctx = {"messages": messages, "request_id": "test-102-complex"}
    ...
    async def test_step_102_preserves_all_context_data(self, mock_rag_log):
        ...
        original_ctx = {
            ...
            "response_metadata": {"provider": "openai", "model": "gpt-4", "tokens_used": 85},
    ...
    async def test_step_102_adds_processing_metadata(self, mock_rag_log):
        ...
        messages = [HumanMessage(content="User question"), AIMessage(content="AI response")]

        ctx = {"messages": messages, "request_id": "test-102-metadata"}
    ...
    async def test_step_102_handles_empty_messages_list(self, mock_rag_log):
        ...
        ctx = {"messages": [], "response_source": "empty_conversation", "request_id": "test-102-empty"}
    ...
    async def test_step_102_logs_processing_details(self, mock_rag_log):
        ...
        ctx = {"messages": messages, "request_id": "test-102-logging"}
...
class TestRAGStep102Parity:
    ...
    async def test_step_102_parity_message_conversion_behavior(self):
        ...
        test_cases = [
            ...
            {"messages": [HumanMessage(content="Question"), AIMessage(content="Answer")], "expected_count": 2},
        ...
        for i, test_case in enumerate(test_cases):
            ctx = {"messages": test_case["messages"], "request_id": f"parity-{i}"}
...
class TestRAGStep102Integration:
    ...
    async def test_final_response_to_102_integration(self, mock_final_log):
        ...
        final_response_ctx = {
            ...
            "conversation_metadata": {"domain_classification": "labor", "confidence": 0.92},
    ...
    async def test_return_cached_to_102_integration(self, mock_cached_log):
        ...
        cached_ctx = {
            "messages": [HumanMessage(content="Cached query"), AIMessage(content="Cached response from Redis")],
    ...
    async def test_step_102_prepares_for_log_complete(self, mock_rag_log):
        ...
        ctx = {
            "messages": [HumanMessage(content="Final user message"), AIMessage(content="Final assistant response")],
            "processing_metrics": {"total_tokens": 150, "processing_time_ms": 1250},
