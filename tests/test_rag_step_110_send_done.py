...
class TestRAGStep110SendDone:
    ...
    async def test_step_110_comprehensive_logging_format(self, mock_logger, mock_rag_log):
        ...
        required_fields = [
            'step', 'step_id', 'node_label', 'streaming_event',
            'streaming_format', 'chunks_sent', 'total_bytes',
            'done_sent', 'client_connected', 'stream_id', 'processing_stage'
        ]
    ...
    async def test_step_110_done_frame_data_structure(self, mock_logger, mock_rag_log):
        ...
        expected_fields = [
            'timestamp', 'streaming_format', 'chunks_sent', 'total_bytes',
            'stream_id', 'done_sent', 'client_connected'
        ]
