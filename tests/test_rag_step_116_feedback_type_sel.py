...
class TestRAGStep116FeedbackTypeSel:
    ...
    async def test_step_116_logs_routing_details(self, mock_rag_log):
        ...
        await step_116__feedback_type_sel(messages=[], ctx=ctx)
    ...
    async def test_step_116_routing_performance_tracking(self, mock_rag_log):
        ...
        ctx = {"response_id": "performance-test-routing", "feedback_type": "faq", "request_id": "test-116-performance"}
...
class TestRAGStep116Parity:
    ...
    async def test_step_116_parity_routing_structure(self):
        ...
        # Test FAQ routing
        ctx_faq = {"feedback_type": "faq", "response_id": "parity-test-faq"}
...
class TestRAGStep116Integration:
    ...
    async def test_step_116_to_117_integration(self, mock_rag_log):
        ...
        step_116_ctx = {
            ...
            "feedback_type": "faq",
            "feedback_data": {"usage_log_id": "usage_123", "was_helpful": True, "comments": "FAQ integration test"},
        ...
        assert (
            step_117_result["next_step"] == "expert_feedback_collector"
        )  # From step 117 (routes to Step 119 per Mermaid)
    ...
    async def test_step_116_to_119_integration(self, mock_rag_log):
        ...
        step_116_ctx = {
            ...
            "expert_user": True,
            "expert_feedback": {"feedback_type": "incorrect", "confidence_rating": 0.9},
    ...
    async def test_step_116_multiple_routing_scenarios(self, mock_rag_log):
        ...
        scenarios = [
            {"name": "faq_explicit", "ctx": {"feedback_type": "faq"}, "expected_decision": "faq_feedback"},
            {
