...
class TestRAGStep120ValidateExpert:
    ...
    async def test_step_120_basic_expert_validation(self, mock_rag_log):
        ...
        ctx = {
            ...
            "feedback_data": {"expert_id": "expert_123", "feedback_type": "incorrect", "confidence_score": 0.9},
    ...
    async def test_step_120_trust_score_calculation(self, mock_rag_log):
        ...
        test_cases = [
            ...
            },
            {
                ...
                "expert_profile": {"credentials": [], "years_experience": 1, "successful_validations": 2},
    ...
    async def test_step_120_logs_validation_details(self, mock_rag_log):
        ...
        ctx = {
            ...
            "feedback_data": {"feedback_type": "correct", "confidence_score": 0.95},
            "expert_profile": {"credentials": ["certified_tax_advisor"], "years_experience": 10},
        }

        await step_120__validate_expert(messages=[], ctx=ctx)
    ...
    async def test_step_120_italian_credentials_validation(self, mock_rag_log):
        ...
        for credential in italian_credentials:
            ctx = {
                ...
                "expert_profile": {"credentials": [credential], "years_experience": 8, "italian_certification": True},
                "feedback_data": {"feedback_type": "incorrect"},
            }
    ...
    async def test_step_120_validation_routing_consistency(self, mock_rag_log):
        ...
        for _scenario in test_scenarios:
            ctx = {"expert_id": "expert_test", "feedback_data": {"feedback_type": "incorrect"}}
...
class TestRAGStep120Parity:
    ...
    async def test_step_120_parity_validation_structure(self):
        ...
        ctx = {
            ...
            "feedback_data": {"feedback_type": "correct"},
            "expert_profile": {"credentials": ["tax_professional"], "years_experience": 5},
        }
...
class TestRAGStep120Integration:
    ...
    async def test_step_119_to_120_integration(self, mock_rag_log, mock_step_119):
        ...
        mock_step_119.return_value = {
            ...
            "feedback_data": {"expert_id": "expert_666", "feedback_type": "incorrect"},
            "expert_validation_required": True,
        }

        # Call Step 119 first
        step_119_result = await mock_step_119(messages=[], ctx={"feedback_data": {"expert_id": "expert_666"}})
    ...
    async def test_step_120_to_121_integration(self, mock_rag_log):
        ...
        step_120_result = await step_120__validate_expert(
            ...
            ctx={
                ...
                "expert_profile": {"credentials": ["certified_tax_advisor"], "years_experience": 12},
            },
        )
    ...
    async def test_full_expert_validation_pipeline(self, mock_rag_log, mock_step_119):
        ...
        mock_step_119.return_value = {
            ...
            "feedback_data": {"expert_id": "expert_888", "feedback_type": "correct"},
            "expert_validation_required": True,
        }
        ...
        test_scenarios = [
            ...
            },
            {
                ...
                "ctx": {
                    ...
                    "expert_profile": {"credentials": [], "years_experience": 0, "successful_validations": 0},
                    "feedback_data": {"feedback_type": "correct"},
                },
                "expected_meets_threshold": False,
            },
