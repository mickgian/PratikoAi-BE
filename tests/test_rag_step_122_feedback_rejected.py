...
class TestRAGStep122FeedbackRejected:
    ...
    async def test_step_122_preserves_context_data(self):
        ...
        ctx = {
            ...
            "expert_feedback": {
                ...
                "expert_data": {"name": "Dr. Context Preserve", "location": "Roma"},
            },
            "trust_score_decision": False,
            "routing_decision": "reject_feedback",
            "threshold_met": False,
            "performance_tracking": {"step_121_duration": 0.025, "decision_start_time": "2023-10-01T10:00:00Z"},
    ...
    async def test_step_122_logs_rejection_details(self):
        ...
        ctx = {
            "expert_validation": {"trust_score": 0.55, "expert_id": "expert_logging", "credentials_validated": False},
    ...
    async def test_step_122_rejection_performance_tracking(self):
        ...
        ctx = {
            "expert_validation": {"trust_score": 0.45, "expert_id": "expert_performance"},
    ...
    async def test_step_122_expert_feedback_outcome_tracking(self):
        ...
        for feedback_type in feedback_types:
            ctx = {
                ...
                "expert_feedback": {"feedback_type": feedback_type, "feedback_text": f"{feedback_type} feedback text"},
                "trust_score_decision": False,
    ...
    async def test_step_122_rejection_metadata_structure(self):
        ...
        ctx = {
            "expert_validation": {"trust_score": 0.6, "expert_id": "expert_metadata", "credentials_validated": False},
...
class TestRAGStep122Parity:
    ...
    async def test_step_122_parity_rejection_structure(self):
        ...
        ctx = {
            "expert_validation": {"trust_score": 0.5, "expert_id": "expert_parity", "credentials_validated": False},
            "expert_feedback": {"feedback_type": "wrong"},
            "trust_score_decision": False,
...
class TestRAGStep122Integration:
    ...
    async def test_step_121_to_122_integration(self):
        ...
        step_121_output = {
            "expert_validation": {
                ...
                "credentials_validated": False,
                "validation_details": {"credentials_score": 0.6, "experience_score": 0.5, "track_record_score": 0.65},
            },
            "expert_feedback": {
                "feedback_type": "incomplete",
                "feedback_text": "Missing key information",
                "expert_data": {"name": "Dr. Integration Test", "location": "Milano"},
            },
            "trust_score_decision": False,
            "next_step": "FeedbackRejected",
            "routing_decision": "reject_feedback",
        ...
        with (
            patch("app.orchestrators.classify.step_121__trust_score_ok") as mock_step_121,
            patch("app.observability.rag_logging.rag_step_log"),
            patch("app.observability.rag_logging.rag_step_timer") as mock_timer,
        ):
    ...
    async def test_step_122_terminal_node_behavior(self):
        ...
        ctx = {
            "expert_validation": {"trust_score": 0.35, "expert_id": "expert_terminal", "credentials_validated": False},
            "expert_feedback": {"feedback_type": "wrong", "feedback_text": "Incorrect information provided"},
            "trust_score_decision": False,
            "threshold_met": False,
    ...
    async def test_multiple_rejection_scenarios(self):
        ...
        scenarios = [
            {
                ...
                "trust_score": 0.2,
                "expert_data": {"name": "New Expert", "certifications": [], "experience_years": 0},
                "feedback_type": "incorrect",
        ...
        for scenario in scenarios:
            ...
            with (
                ...
                assert result["feedback_rejected"] is True, f"Failed rejection for scenario: {scenario['name']}"
