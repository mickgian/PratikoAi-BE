...
class TestRAGStep128GoldenApproval:
    ...
    async def test_step_128_auto_approves_high_quality_candidate(self, mock_rag_log):
        ...
        ctx = {
            ...
            "candidate_metadata": {"candidate_id": "candidate_high", "trust_score": 0.94, "expert_confidence": 0.98},
    ...
    async def test_step_128_rejects_low_quality_candidate(self, mock_rag_log):
        ...
        ctx = {
            ...
            "candidate_metadata": {"candidate_id": "candidate_low", "trust_score": 0.72, "expert_confidence": 0.68},
    ...
    async def test_step_128_preserves_context(self, mock_rag_log):
        ...
        original_ctx = {
            "faq_candidate": {"question": "Test question", "answer": "Test answer", "quality_score": 0.96},
    ...
    async def test_step_128_adds_approval_metadata(self, mock_rag_log):
        ...
        ctx = {
            "faq_candidate": {"question": "Question", "answer": "Answer", "quality_score": 0.97},
    ...
    async def test_step_128_handles_missing_quality_score(self, mock_rag_log):
        ...
        ctx = {
            ...
            "candidate_metadata": {"candidate_id": "candidate_no_score"},
    ...
    async def test_step_128_logs_approval_decision(self, mock_rag_log):
        ...
        ctx = {
            "faq_candidate": {"question": "Test question for logging", "answer": "Test answer", "quality_score": 0.96},
...
class TestRAGStep128Parity:
    ...
    async def test_step_128_parity_approval_logic(self):
        ...
        test_cases = [
            {"faq_candidate": {"quality_score": 0.97}, "expected_decision": "auto_approved"},
            {"faq_candidate": {"quality_score": 0.65}, "expected_decision": "rejected"},
            {"faq_candidate": {"quality_score": 0.88}, "expected_decision": "manual_review_required"},
        ]
...
class TestRAGStep128Integration:
    ...
    async def test_golden_candidate_to_128_integration(self, mock_golden_log):
        ...
        initial_ctx = {
            ...
            "candidate_metadata": {"candidate_id": "candidate_integration", "source": "expert_feedback"},
            "trust_score": 0.93,
    ...
    async def test_step_128_prepares_for_publish_golden(self, mock_rag_log):
        ...
        ctx = {
            ...
            "candidate_metadata": {"candidate_id": "candidate_publish"},
    ...
    async def test_step_128_routes_rejection_to_feedback_end(self, mock_rag_log):
        ...
        ctx = {
            "faq_candidate": {"question": "Low quality", "answer": "Low quality answer", "quality_score": 0.60},
            "candidate_metadata": {"candidate_id": "candidate_reject"},
