...
class TestRAGStep12ExtractQuery:
    ...
    def mock_single_user_message(self):
        ...
        return [Message(role="user", content="Calculate my income tax for 2024")]
    ...
    async def test_step_12_single_user_message(self, mock_logger, mock_rag_log, mock_single_user_message):
        ...
        ctx = {"converted_messages": mock_single_user_message, "message_count": 1, "request_id": "req_456"}
    ...
    async def test_step_12_no_user_messages(self, mock_logger, mock_rag_log, mock_no_user_messages):
        ...
        ctx = {"converted_messages": mock_no_user_messages, "message_count": 2, "request_id": "req_nouser"}
    ...
    async def test_step_12_empty_messages(self, mock_logger, mock_rag_log):
        ...
        ctx = {"converted_messages": [], "message_count": 0, "request_id": "req_empty"}
    ...
    async def test_step_12_message_content_analysis(self, mock_logger, mock_rag_log):
        ...
        complex_messages = [
            ...
            Message(
                role="user",
                content="This is a very long user query that contains multiple sentences. It asks about complex tax regulations for small businesses. The user wants detailed information about deductions, filing requirements, and compliance rules.",
            ),
        ]

        ctx = {"converted_messages": complex_messages, "request_id": "req_analysis"}
    ...
    async def test_step_12_message_extraction_order(self, mock_logger, mock_rag_log):
        ...
        ctx = {"converted_messages": time_ordered_messages, "request_id": "req_order"}
    ...
    async def test_step_12_query_preprocessing(self, mock_logger, mock_rag_log):
        ...
        messy_messages = [Message(role="user", content="  \n\t What are my tax obligations?  \n  ")]

        ctx = {"converted_messages": messy_messages, "request_id": "req_preprocess"}
    ...
    async def test_step_12_ready_for_classification(self, mock_logger, mock_rag_log, mock_conversation_messages):
        ...
        ctx = {"converted_messages": mock_conversation_messages, "request_id": "req_ready"}
    ...
    async def test_step_12_comprehensive_logging(self, mock_logger, mock_rag_log, mock_conversation_messages):
        ...
        ctx = {"converted_messages": mock_conversation_messages, "request_id": "req_comprehensive"}
    ...
    async def test_step_12_performance_tracking(self, mock_logger, mock_rag_log, mock_conversation_messages):
        ...
        with patch("app.orchestrators.classify.rag_step_timer") as mock_timer:
            ...
            ctx = {"converted_messages": mock_conversation_messages, "request_id": "req_perf"}
    ...
    async def test_step_12_parity_preservation(self, mock_logger, mock_rag_log, mock_conversation_messages):
        ...
        ctx = {"converted_messages": mock_conversation_messages, "request_id": "req_parity"}
