...
class TestStep133FetchFeedsUnit:
    ...
    async def test_successful_feed_fetching_and_parsing(self, sample_rss_context, sample_parsed_feeds):
        ...
        with (
            ...
            mock_fetch.return_value = {
                ...
                "processing_summary": {"successful_feeds": 2, "failed_feeds": 0, "total_processing_time_seconds": 8.5},
            }
    ...
    async def test_feed_fetching_with_no_feeds_provided(self):
        ...
        ctx = {"request_id": "fetch-test-no-feeds", "rss_feeds": [], "new_item_count": 0, "feed_sources": []}
    ...
    async def test_feed_fetching_with_partial_failures(self):
        ...
        with (
            ...
            mock_fetch.return_value = {
                ...
                "parsed_feeds": [
                    {"feed_name": "agenzia_entrate_circolari", "parsing_status": "success", "items_parsed": 2}
                ],
                "processing_summary": {"successful_feeds": 1, "failed_feeds": 1},
                "errors": ["Failed to fetch feed: https://invalid-feed.example.com/rss.xml"],
            }
        ...
        for authority, feed_types in test_cases:
            ...
            with (
                ...
                mock_fetch.return_value = {
                    ...
                    "parsed_feeds": [],
                    "processing_summary": {"successful_feeds": len(feed_types), "failed_feeds": 0},
                }
...
class TestStep133FetchFeedsIntegration:
    ...
    async def test_background_scheduled_feed_processing(self):
        ...
        scheduled_ctx = {
            ...
            "new_item_count": 5,
            "feed_sources": ["agenzia_entrate", "inps"],
            "processing_config": {"priority_processing": True, "max_concurrent_feeds": 10, "timeout_seconds": 30},
        }
    ...
    async def test_manual_triggered_feed_processing(self):
            ...
            "rss_feeds": [
                {
                    ...
                    "processing_options": {
                        ...
                        "date_range": {"start_date": "2024-01-01", "end_date": "2024-01-15"},
                    },
                }
            ],
            "new_item_count": 8,
        ...
        with (
            ...
            mock_fetch.return_value = {
                ...
                "parsed_feeds": [
                    {"feed_name": "gazzetta_ufficiale_serie_generale", "items_parsed": 8, "date_filtered": True}
                ],
                "processing_summary": {"successful_feeds": 1},
            }
    ...
    async def test_output_structure_consistency(self):
        ...
        for scenario in test_scenarios:
            ...
            with (
                ...
                required_keys = ["step", "status", "feeds_fetched", "total_items_parsed"]
