...
class TestRAGStep14ExtractFacts:
    ...
    async def test_step_14_extract_dates(self, mock_rag_log):
        ...
        ctx = {
            'user_message': 'Le scadenze per il 730 del 2024 sono il 30 settembre',
            'request_id': 'test-14-dates'
        }
    ...
    async def test_step_14_extract_professional_categories(self, mock_rag_log):
        ...
        assert any('commercio' in text.lower() or 'dirigente' in text.lower() or 'indeterminato' in text.lower() for text in category_texts)
    ...
    async def test_step_14_routes_to_canonicalize(self, mock_rag_log):
        ...
        ctx = {
            'user_message': 'Stipendio di 2000 euro al mese',
            'request_id': 'test-14-route'
        }
