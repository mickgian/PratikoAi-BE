...
class TestRAGStep17AttachmentFingerprint:
    ...
    async def test_step_17_single_attachment_hash(self, mock_rag_log):
        ...
        ctx = {"attachments": [attachment], "request_id": "test-17-single"}
    ...
    async def test_step_17_multiple_attachments(self, mock_rag_log):
        ...
        attachments = [
            ...
            {"filename": "receipt.jpg", "content": b"Receipt image data", "mime_type": "image/jpeg", "size": 1500},
            {
        ...
        ctx = {"attachments": attachments, "request_id": "test-17-multiple"}
    ...
    async def test_step_17_duplicate_content_detection(self, mock_rag_log):
        ...
        attachments = [
            {"filename": "file1.txt", "content": same_content, "mime_type": "text/plain", "size": 27},
            {"filename": "file2.txt", "content": same_content, "mime_type": "text/plain", "size": 27},
        ]

        ctx = {"attachments": attachments, "request_id": "test-17-duplicate"}
    ...
    async def test_step_17_empty_content(self, mock_rag_log):
        ...
        attachment = {"filename": "empty.txt", "content": b"", "mime_type": "text/plain", "size": 0}

        ctx = {"attachments": [attachment], "request_id": "test-17-empty"}
    ...
    async def test_step_17_large_file(self, mock_rag_log):
        ...
        ctx = {"attachments": [attachment], "request_id": "test-17-large"}
    ...
    async def test_step_17_no_attachments(self, mock_rag_log):
        ...
        ctx = {"attachments": [], "request_id": "test-17-none"}
...
class TestRAGStep17Parity:
    ...
    async def test_step_17_parity_hash_algorithm(self, mock_rag_log):
        ...
        attachment = {"filename": "test.txt", "content": content, "mime_type": "text/plain", "size": len(content)}

        ctx = {"attachments": [attachment], "request_id": "test-parity-hash"}
    ...
    async def test_step_17_parity_document_model(self, mock_rag_log):
        ...
        ctx = {"attachments": [attachment], "request_id": "test-parity-model"}
...
class TestRAGStep17Integration:
    ...
    async def test_step_17_routes_to_step_18(self, mock_rag_log):
        ...
        attachments = [{"filename": "doc.pdf", "content": b"PDF content", "mime_type": "application/pdf", "size": 100}]

        ctx = {"attachments": attachments, "request_id": "test-17-route"}
    ...
    async def test_step_17_prepares_for_validation(self, mock_rag_log):
        ...
        attachments = [{"filename": "test.pdf", "content": b"Test PDF", "mime_type": "application/pdf", "size": 8}]

        ctx = {"attachments": attachments, "request_id": "test-17-validation-prep"}
    ...
    async def test_step_17_hash_for_caching(self, mock_rag_log):
        ...
        ctx = {"attachments": attachments, "request_id": "test-17-cache"}
