...
class TestRAGStep19AttachmentsPresent:
    ...
    async def test_step_19_attachments_present(self, mock_rag_log):
        ...
        fingerprints = [{"hash": "abc123", "filename": "doc.pdf", "size": 1024}]

        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-19-present"}
    ...
    async def test_step_19_no_attachments(self, mock_rag_log):
        ...
        ctx = {"fingerprints": [], "attachment_count": 0, "request_id": "test-19-none"}
    ...
    async def test_step_19_multiple_attachments(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 3, "request_id": "test-19-multiple"}
    ...
    async def test_step_19_empty_fingerprints_list(self, mock_rag_log):
        ...
        ctx = {"fingerprints": [], "attachment_count": 0, "request_id": "test-19-empty"}
    ...
    async def test_step_19_missing_fingerprints_field(self, mock_rag_log):
        ...
        ctx = {"attachment_count": 0, "request_id": "test-19-missing"}
...
class TestRAGStep19Parity:
    ...
    async def test_step_19_parity_routing_logic(self, mock_rag_log):
        ...
        ctx_with = {"fingerprints": [{"hash": "abc"}], "attachment_count": 1, "request_id": "test-parity-with"}
        ...
        ctx_without = {"fingerprints": [], "attachment_count": 0, "request_id": "test-parity-without"}
...
class TestRAGStep19Integration:
    ...
    async def test_step_17_to_19_integration(self, mock_rag_log):
        ...
        step_17_ctx = {"attachments": attachments, "request_id": "test-integration-17-19"}
    ...
    async def test_step_19_to_84_validation_flow(self, mock_rag_log):
        ...
        fingerprints = [{"hash": "abc123", "filename": "invoice.pdf", "size": 2048}]

        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-19-to-84"}
    ...
    async def test_step_19_to_24_golden_flow(self, mock_rag_log):
        ...
        ctx = {"fingerprints": [], "attachment_count": 0, "request_id": "test-19-to-24"}
