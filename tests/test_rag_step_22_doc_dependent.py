...
class TestRAGStep22DocDependent:
    ...
    async def test_step_22_query_independent(self, mock_rag_log):
        ...
        ctx = {
            ...
            "extracted_docs": [{"filename": "random.pdf", "detected_type": "pdf"}],
            "document_count": 1,
    ...
    async def test_step_22_filename_context(self, mock_rag_log):
        ...
        ctx = {
            ...
            "extracted_docs": [
                {
                    "filename": "fattura_elettronica_2024.xml",
                    "detected_type": "xml",
...
class TestRAGStep22Integration:
    ...
    async def test_step_21_to_22_integration(self, mock_rag_log):
        ...
        fingerprints = [{"hash": "abc", "filename": "fattura_2024.pdf", "size": 1024, "mime_type": "application/pdf"}]

        step_21_ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-integration-21-22"}
    ...
    async def test_step_22_to_24_golden_flow(self, mock_rag_log):
        ...
        ctx = {
            ...
            "extracted_docs": [{"filename": "some_doc.pdf", "detected_type": "pdf"}],
            "document_count": 1,
