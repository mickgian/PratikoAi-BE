...
class TestRAGStep28ServeGolden:
    ...
    async def test_step_28_includes_faq_metadata(self, mock_rag_log):
        ...
        ctx = {
            ...
            "golden_match": {
                ...
                "category": "pension",
                "updated_at": datetime.now(UTC).isoformat(),
                "metadata": {"regulatory_refs": ["DL 123/2020"], "last_validated": "2024-01-15"},
            },
    ...
    async def test_step_28_formats_citations_correctly(self, mock_rag_log):
        ...
        ctx = {
            "golden_match": {
                ...
                "metadata": {"regulatory_refs": ["CCNL 2023", "Art. 45"], "source_url": "https://example.com/faq/003"},
            },
    ...
    async def test_step_28_logs_serving_details(self, mock_rag_log):
        ...
        await step_28__serve_golden(messages=[], ctx=ctx)
    ...
    async def test_step_28_includes_timing_metadata(self, mock_rag_log):
        ...
        ctx = {
            "golden_match": {"faq_id": "faq_001", "answer": "Test", "updated_at": datetime.now(UTC).isoformat()},
