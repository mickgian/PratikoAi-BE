...
class TestRAGStep4GDPRLog:
    ...
    async def test_step_4_successful_gdpr_logging(
        self, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request
    ):
        ...
        ctx = {
            ...
            "request_metadata": {"method": "POST", "url": "/api/v1/chat", "request_id": "req_123"},
        }
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.privacy.gdpr.gdpr_compliance")
    async def test_step_4_gdpr_service_error(
        self, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request
    ):
    ...
    async def test_step_4_privacy_anonymization_enabled(
        self, mock_settings, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request
    ):
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.privacy.gdpr.gdpr_compliance")
    async def test_step_4_different_data_categories(
        self, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user
    ):
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.privacy.gdpr.gdpr_compliance")
    async def test_step_4_ready_for_step_6(
        self, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request
    ):
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.privacy.gdpr.gdpr_compliance")
    async def test_step_4_comprehensive_logging(
        self, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request
    ):
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.privacy.gdpr.gdpr_compliance")
    async def test_step_4_performance_tracking(
        self, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request
    ):
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.privacy.gdpr.gdpr_compliance")
    async def test_step_4_parity_preservation(
        self, mock_gdpr, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request
    ):
