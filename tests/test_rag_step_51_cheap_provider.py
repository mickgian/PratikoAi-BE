...
class TestRAGStep51CheapProvider:
    ...
    def mock_messages(self):
        ...
        return [Message(role="user", content="Calculate my tax deductions")]
    ...
    async def test_step_51_select_cheapest_provider_success(
        self, mock_get_factory, mock_logger, mock_rag_log, mock_messages, mock_cheap_provider
    ):
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.llm.factory.get_llm_factory")
    async def test_step_51_no_cheap_provider_available(
        self, mock_get_factory, mock_logger, mock_rag_log, mock_messages
    ):
    ...
    async def test_step_51_factory_error(self, mock_get_factory, mock_logger, mock_rag_log, mock_messages):
        ...
        ctx = {"messages": mock_messages, "max_cost_eur": 0.5}
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.llm.factory.get_llm_factory")
    async def test_step_51_with_preferences(
        self, mock_get_factory, mock_logger, mock_rag_log, mock_messages, mock_cheap_provider
    ):
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.llm.factory.get_llm_factory")
    async def test_step_51_ready_for_step_55(
        self, mock_get_factory, mock_logger, mock_rag_log, mock_messages, mock_cheap_provider
    ):
        ...
        ctx = {"messages": mock_messages, "max_cost_eur": 0.5, "routing_strategy": "cost_optimized"}
    ...
    @patch("app.core.logging.logger")
    @patch("app.core.llm.factory.get_llm_factory")
    async def test_step_51_comprehensive_logging(
        self, mock_get_factory, mock_logger, mock_rag_log, mock_messages, mock_cheap_provider
    ):
        ...
        ctx = {"messages": mock_messages, "max_cost_eur": 0.5, "preferred_provider": "openai"}
