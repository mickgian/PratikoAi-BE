...
class TestRAGStep67LLMSuccess:
    ...
    async def test_step_67_llm_call_successful(self, mock_rag_log):
        ...
        # Call orchestrator
        ctx = {"llm_response": llm_response, "error": None, "exception": None, "request_id": "test-67-success"}
...
class TestRAGStep67Parity:
    ...
    async def test_step_67_parity_success_behavior(self, mock_rag_log):
        ...
        llm_response = LLMResponse(
            content="Test response", tool_calls=[], cost_estimate=0.001, model="gpt-3.5-turbo", provider="openai"
        )
        ...
        ctx = {"llm_response": llm_response, "request_id": "test-67-parity"}
