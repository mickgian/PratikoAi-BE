...
class TestRAGStep6PrivacyCheck:
    ...
    async def test_step_6_privacy_enabled(self, mock_logger, mock_rag_log, mock_settings, mock_session, mock_user, mock_validated_request, mock_gdpr_record):
    ...
    async def test_step_6_privacy_disabled(self, mock_settings, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request, mock_gdpr_record):
    ...
    @patch('app.core.logging.logger')
    @patch('app.core.config.settings')
    async def test_step_6_environment_specific_settings(self, mock_settings, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request):
    ...
    @patch('app.core.logging.logger')
    @patch('app.core.config.settings')
    async def test_step_6_user_specific_privacy_preferences(self, mock_settings, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request):
    ...
    @patch('app.core.logging.logger')
    @patch('app.core.config.settings')
    async def test_step_6_ready_for_step_7_or_8(self, mock_settings, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request):
    ...
    @patch('app.core.logging.logger')
    @patch('app.core.config.settings')
    async def test_step_6_comprehensive_logging(self, mock_settings, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request):
        ...
        required_fields = [
            ...
            'privacy_enabled', 'anonymization_required', 'decision',
            'processing_stage', 'next_step', 'session_id', 'user_id'
        ]
    ...
    async def test_step_6_performance_tracking(self, mock_settings, mock_logger, mock_rag_log, mock_validated_request):
        ...
        with patch('app.orchestrators.privacy.rag_step_timer') as mock_timer:
            ...
            mock_timer.assert_called_with(
                6,
                'RAG.privacy.privacy.anonymize.requests.enabled',
                'PrivacyCheck',
                stage='start'
            )
    ...
    @patch('app.core.logging.logger')
    @patch('app.core.config.settings')
    async def test_step_6_decision_branching(self, mock_settings, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request):
    ...
    @patch('app.core.logging.logger')
    @patch('app.core.config.settings')
    async def test_step_6_parity_preservation(self, mock_settings, mock_logger, mock_rag_log, mock_session, mock_user, mock_validated_request):
