    ...
    async def test_step_81_handles_search_query(self, mock_rag_log):
        ...
        ctx = {
            'tool_args': {
                'query_type': 'search',
                'sector': 'commerce',
                'search_terms': 'preavviso dimissioni'
            },
...
class TestRAGStep81Parity:
    ...
    async def test_step_81_parity_with_ccnl_tool(self, mock_rag_log):
        ...
        tool_args = {
            'query_type': 'search',
            'sector': 'metalworking',
            'search_terms': 'straordinario notturno'
        }
    ...
    async def test_step_79_to_81_integration(self, mock_ccnl_log):
        ...
        step_79_output = {
            ...
            'tool_args': {
                'query_type': 'search',
                'sector': 'commerce',
                'search_terms': 'permessi retribuiti'
            },
