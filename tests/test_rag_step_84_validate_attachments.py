...
class TestRAGStep84ValidateAttachments:
    ...
    async def test_step_84_valid_single_attachment(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-84-valid"}
    ...
    async def test_step_84_file_too_large(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-84-large"}
    ...
    async def test_step_84_too_many_files(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 6, "request_id": "test-84-many"}
    ...
    async def test_step_84_unsupported_mime_type(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-84-unsupported"}
    ...
    async def test_step_84_multiple_valid_attachments(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 3, "request_id": "test-84-multiple"}
    ...
    async def test_step_84_multiple_errors(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-84-multi-error"}
    ...
    async def test_step_84_edge_case_exact_limit(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-84-exact"}
    ...
    async def test_step_84_empty_attachments(self, mock_rag_log):
        ...
        ctx = {"fingerprints": [], "attachment_count": 0, "request_id": "test-84-empty"}
...
class TestRAGStep84Parity:
    ...
    async def test_step_84_parity_size_check(self, mock_rag_log):
        ...
        ctx_at = {"fingerprints": fingerprints_at_limit, "attachment_count": 1, "request_id": "test-parity-at"}
        ...
        ctx_over = {"fingerprints": fingerprints_over, "attachment_count": 1, "request_id": "test-parity-over"}
    ...
    async def test_step_84_parity_count_check(self, mock_rag_log):
        ...
        ctx_at = {"fingerprints": fingerprints_at, "attachment_count": max_files, "request_id": "test-parity-count-at"}
    ...
    async def test_step_84_parity_mime_types(self, mock_rag_log):
        ...
        for mime_type in DOCUMENT_CONFIG["SUPPORTED_MIME_TYPES"].keys():
            ...
            fingerprints = [{"hash": "test", "filename": "test.file", "size": 1024, "mime_type": mime_type}]

            ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": f"test-parity-mime-{mime_type}"}
...
class TestRAGStep84Integration:
    ...
    async def test_step_19_to_84_integration(self, mock_rag_log):
        ...
        fingerprints = [{"hash": "abc", "filename": "doc.pdf", "size": 1024 * 1024, "mime_type": "application/pdf"}]

        step_19_ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-integration-19-84"}
    ...
    async def test_step_84_to_85_valid_flow(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-84-to-85-valid"}
    ...
    async def test_step_84_to_85_invalid_flow(self, mock_rag_log):
        ...
        ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-84-to-85-invalid"}
