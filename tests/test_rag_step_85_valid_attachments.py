...
class TestRAGStep85ValidAttachments:
    ...
    async def test_step_85_attachments_valid(self, mock_rag_log):
        ...
        ctx = {"validation_passed": True, "attachment_count": 2, "errors": [], "request_id": "test-85-valid"}
    ...
    async def test_step_85_empty_errors_list_valid(self, mock_rag_log):
        ...
        ctx = {"validation_passed": True, "attachment_count": 1, "errors": [], "request_id": "test-85-empty-errors"}
    ...
    async def test_step_85_missing_validation_field(self, mock_rag_log):
        ...
        ctx = {"attachment_count": 1, "errors": [], "request_id": "test-85-missing"}
...
class TestRAGStep85Parity:
    ...
    async def test_step_85_parity_routing_logic(self, mock_rag_log):
        ...
        ctx_valid = {"validation_passed": True, "errors": [], "attachment_count": 1, "request_id": "test-parity-valid"}
...
class TestRAGStep85Integration:
    ...
    async def test_step_84_to_85_integration(self, mock_rag_log):
        ...
        step_84_ctx = {"fingerprints": fingerprints, "attachment_count": 1, "request_id": "test-integration-84-85"}
    ...
    async def test_step_85_to_21_valid_flow(self, mock_rag_log):
        ...
        ctx = {"validation_passed": True, "errors": [], "attachment_count": 2, "request_id": "test-85-to-21"}
