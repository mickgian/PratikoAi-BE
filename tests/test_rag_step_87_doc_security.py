...
class TestRAGStep87DocSecurity:
    ...
    async def test_step_87_sanitize_pdf_with_javascript(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-87-pdf-js"}
    ...
    async def test_step_87_sanitize_office_with_macros(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-87-macro"}
    ...
    async def test_step_87_clean_document(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-87-clean"}
    ...
    async def test_step_87_multiple_documents(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 3, "request_id": "test-87-multi"}
    ...
    async def test_step_87_detect_activex(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-87-activex"}
    ...
    async def test_step_87_detect_xxe(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-87-xxe"}
    ...
    async def test_step_87_threat_details(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-87-details"}
...
class TestRAGStep87Parity:
    ...
    async def test_step_87_parity_pdf_javascript_detection(self, mock_rag_log):
        ...
        extracted_docs = [
            {"filename": "test.pdf", "content": pdf_content, "mime_type": "application/pdf", "detected_type": "pdf"}
        ]

        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-parity"}
    ...
    async def test_step_87_parity_script_content_detection(self, mock_rag_log):
        ...
        for content, expected_threat_type in test_cases:
            extracted_docs = [
                {"filename": "test.txt", "content": content, "mime_type": "text/plain", "detected_type": "txt"}
            ]

            ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-parity-script"}
...
class TestRAGStep87Integration:
    ...
    async def test_step_85_to_87_integration(self, mock_rag_log):
        ...
        step_85_ctx = {
            ...
            "errors": [],
            "attachment_count": 1,
            "fingerprints": [{"hash": "abc", "filename": "doc.pdf", "size": 1024, "mime_type": "application/pdf"}],
            "extracted_docs": [
                {
                    "filename": "doc.pdf",
                    "content": b"%PDF-1.4\nClean content\n%%EOF",
    ...
    async def test_step_87_to_88_flow(self, mock_rag_log):
        ...
        ctx = {"extracted_docs": extracted_docs, "document_count": 1, "request_id": "test-87-to-88"}
