...
class TestRAGStep89DocType:
    ...
    async def test_step_89_route_fattura_xml(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-89-fattura"}
    ...
    async def test_step_89_route_f24(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-89-f24"}
    ...
    async def test_step_89_route_contratto(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-89-contratto"}
    ...
    async def test_step_89_route_busta_paga(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-89-payslip"}
    ...
    async def test_step_89_route_generic(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-89-generic"}
    ...
    async def test_step_89_first_document_routing(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 2, "request_id": "test-89-first"}
...
class TestRAGStep89Parity:
    ...
    async def test_step_89_parity_routing_map(self, mock_rag_log):
        ...
        for doc_type, expected_route in routing_map:
            ...
            ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": f"test-parity-{doc_type}"}
...
class TestRAGStep89Integration:
    ...
    async def test_step_88_to_89_integration(self, mock_rag_log):
        ...
        step_88_ctx = {"sanitized_docs": sanitized_docs, "document_count": 1, "request_id": "test-integration-88-89"}
    ...
    async def test_step_89_routing_decision_paths(self, mock_rag_log):
        ...
        for doc_type, expected_next, _expected_step in test_cases:
            classified_docs = [
                {
            ...
            ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": f"test-route-{doc_type}"}
