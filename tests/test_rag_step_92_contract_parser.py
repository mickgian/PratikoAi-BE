...
class TestRAGStep92ContractParser:
    ...
    async def test_step_92_parse_contract_pdf(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-92-contract"}
    ...
    async def test_step_92_extract_contract_fields(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-92-extract"}
    ...
    async def test_step_92_invalid_contract(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-92-invalid"}
    ...
    async def test_step_92_routes_to_extract_facts(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-92-route"}
...
class TestRAGStep92Integration:
    ...
    async def test_step_89_to_92_integration(self, mock_rag_log):
        ...
        step_89_ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-integration-89-92"}
    ...
    async def test_step_92_to_95_flow(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-92-to-95"}
