...
class TestRAGStep93PayslipParser:
    ...
    async def test_step_93_parse_payslip_pdf(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-93-payslip"}
    ...
    async def test_step_93_extract_payslip_fields(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-93-extract"}
    ...
    async def test_step_93_invalid_payslip(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-93-invalid"}
    ...
    async def test_step_93_routes_to_extract_facts(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-93-route"}
...
class TestRAGStep93Integration:
    ...
    async def test_step_89_to_93_integration(self, mock_rag_log):
        ...
        step_89_ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-integration-89-93"}
    ...
    async def test_step_93_to_95_flow(self, mock_rag_log):
        ...
        ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-93-to-95"}
