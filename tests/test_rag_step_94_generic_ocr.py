...
class TestRAGStep94Integration:
    ...
    async def test_step_89_to_94_integration(self, mock_rag_log):
        ...
        step_89_ctx = {
            'classified_docs': classified_docs,
            'document_count': 1,
            'request_id': 'test-integration-89-94'
        }
