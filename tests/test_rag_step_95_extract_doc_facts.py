...
class TestRAGStep95ExtractDocFacts:
    ...
    async def test_step_95_extract_from_fattura(self, mock_rag_log):
        ...
        ctx = {"parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-95-fattura"}
    ...
    async def test_step_95_extract_from_f24(self, mock_rag_log):
        ...
        ctx = {"parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-95-f24"}
    ...
    async def test_step_95_extract_from_contract(self, mock_rag_log):
        ...
        ctx = {"parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-95-contract"}
    ...
    async def test_step_95_extract_from_payslip(self, mock_rag_log):
        ...
        ctx = {"parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-95-payslip"}
    ...
    async def test_step_95_routes_to_store_blob(self, mock_rag_log):
        ...
        ctx = {"parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-95-route"}
...
class TestRAGStep95Parity:
    ...
    async def test_step_95_parity_multiple_docs(self, mock_rag_log):
        ...
        ctx = {"parsed_docs": parsed_docs, "document_count": 2, "request_id": "test-parity"}
...
class TestRAGStep95Integration:
    ...
    async def test_step_90_to_95_integration(self, mock_rag_log):
        ...
        step_90_ctx = {"classified_docs": classified_docs, "document_count": 1, "request_id": "test-integration-90-95"}
        ...
        parsed_docs = [
            {
                ...
                "document_type": "contratto",
                "parsed_successfully": True,
                "extracted_fields": {"tipo_contratto": "appalto", "corrispettivo": "1.500.000.00"},
            }
        ]

        ctx = {"parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-95-to-96"}
