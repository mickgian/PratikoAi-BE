...
class TestRAGStep96StoreBlob:
    ...
    async def test_step_96_store_document_blob(self, mock_rag_log):
        ...
        ctx = {"facts": facts, "parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-96-store"}
    ...
    async def test_step_96_ttl_configuration(self, mock_rag_log):
        ...
        ctx = {"facts": facts, "parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-96-ttl"}
    ...
    async def test_step_96_encryption_metadata(self, mock_rag_log):
        ...
        ctx = {"facts": facts, "parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-96-encrypt"}
    ...
    async def test_step_96_routes_to_provenance(self, mock_rag_log):
        ...
        parsed_docs = [
            {"filename": "doc.pdf", "document_type": "generic", "content": b"content", "parsed_successfully": True}
        ]

        ctx = {"facts": facts, "parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-96-route"}
...
class TestRAGStep96Parity:
    ...
    async def test_step_96_parity_multiple_docs(self, mock_rag_log):
        ...
        parsed_docs = [
            {"filename": "doc1.pdf", "document_type": "generic", "content": b"content1", "parsed_successfully": True},
            {"filename": "doc2.pdf", "document_type": "generic", "content": b"content2", "parsed_successfully": True},
        ]

        ctx = {"facts": facts, "parsed_docs": parsed_docs, "document_count": 2, "request_id": "test-parity"}
...
class TestRAGStep96Integration:
        ...
        parsed_docs = [
            {
                ...
                "content": b'<?xml version="1.0"?><data>test</data>',
                "parsed_successfully": True,
                "extracted_fields": {"numero": "100", "importo": "5000.00"},
            }
        ]

        step_95_ctx = {"parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-integration-95-96"}
    ...
    async def test_step_96_to_97_flow(self, mock_rag_log):
        ...
        facts = [{"type": "document_field", "field_name": "importo", "value": "1500000.00"}]
        parsed_docs = [
            {
        ...
        ctx = {"facts": facts, "parsed_docs": parsed_docs, "document_count": 1, "request_id": "test-96-to-97"}
