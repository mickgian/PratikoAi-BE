...
class TestRAGStep97Provenance:
    ...
    async def test_step_97_log_provenance_entry(self, mock_rag_log):
        ...
        blob_ids = [
            {"blob_id": "abc123", "filename": "fattura.xml", "document_type": "fattura_elettronica", "size": 1024}
        ]

        facts = [{"type": "document_field", "field_name": "numero", "value": "001", "source_file": "fattura.xml"}]

        ctx = {"blob_ids": blob_ids, "facts": facts, "document_count": 1, "request_id": "test-97-provenance"}
    ...
    async def test_step_97_ledger_metadata(self, mock_rag_log):
        ...
        blob_ids = [{"blob_id": "def456", "filename": "contract.pdf", "document_type": "contratto"}]

        facts = [{"type": "test", "value": "data"}]

        ctx = {"blob_ids": blob_ids, "facts": facts, "document_count": 1, "request_id": "test-97-metadata"}
    ...
    async def test_step_97_immutable_ledger(self, mock_rag_log):
        ...
        ctx = {"blob_ids": blob_ids, "facts": facts, "document_count": 1, "request_id": "test-97-immutable"}
    ...
    async def test_step_97_routes_to_tool_results(self, mock_rag_log):
        ...
        ctx = {"blob_ids": blob_ids, "facts": facts, "document_count": 1, "request_id": "test-97-route"}
...
class TestRAGStep97Parity:
    ...
    async def test_step_97_parity_multiple_docs(self, mock_rag_log):
        ...
        blob_ids = [{"blob_id": "abc1", "filename": "doc1.pdf"}, {"blob_id": "abc2", "filename": "doc2.pdf"}]
        facts = [{"type": "field", "value": "data1"}, {"type": "field", "value": "data2"}]

        ctx = {"blob_ids": blob_ids, "facts": facts, "document_count": 2, "request_id": "test-parity"}
...
class TestRAGStep97Integration:
    ...
    async def test_step_96_to_97_integration(self, mock_rag_log):
        ...
        # Step 96: Store blobs
        facts = [{"type": "document_field", "field_name": "numero", "value": "100", "source_file": "fattura.xml"}]
        parsed_docs = [
            {
    ...
    async def test_step_97_to_98_flow(self, mock_rag_log):
        ...
        blob_ids = [{"blob_id": "xyz789", "filename": "contract.pdf", "document_type": "contratto"}]
        facts = [{"type": "document_field", "field_name": "tipo_contratto", "value": "appalto"}]

        ctx = {"blob_ids": blob_ids, "facts": facts, "document_count": 1, "request_id": "test-97-to-98"}
