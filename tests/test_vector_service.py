...
class TestVectorService:
    ...
    def test_store_document_success(self):
        ...
        result = service.store_document(document_id="test-doc", text="test content", metadata={"type": "test"})
    ...
    def test_hybrid_search_semantic_only(self):
        ...
        mock_semantic_results = [{"id": "doc-1", "score": 0.9, "metadata": {"type": "test"}}]
    ...
    def test_hybrid_search_with_keyword_results(self):
        ...
        # Mock search_similar_documents method
        mock_semantic_results = [{"id": "doc-1", "score": 0.8, "metadata": {"type": "test"}}]
        service.search_similar_documents = Mock(return_value=mock_semantic_results)

        keyword_results = [{"id": "doc-2", "score": 0.6, "metadata": {"type": "keyword"}}]

        results = service.hybrid_search(query="test query", keyword_results=keyword_results, semantic_weight=0.7)
    ...
    def test_search_italian_knowledge_with_filters(self):
        ...
        results = service.search_italian_knowledge(query="test query", knowledge_type="regulation", language="italian")
