...
# Setup database
export VERSION_REGISTRY_DB_URL="postgresql://user:pass@localhost/version_registry"  # pragma: allowlist secret
...
# Database
VERSION_REGISTRY_DB_URL=postgresql://user:pass@localhost/version_registry  # pragma: allowlist secret
